...
!function(n, r) {
    ...
    !function(y, b) {
        ...
        b.renderOneActivity = function(e, t) {
            ...
            b.log("Current activity: "), b.each(t, function(e) {
                b.doLog(e);
            });
            ...
            b.activityTracing && b.activityTrace.push(r), b.passLogLevel(b.logLevel.TRACE) && b.doLog(b.renderOneActivity(r, !0)), 
            ...
            if (b.isLogLevel(e[0]) && (t = e.shift()), b.passLogLevel(t)) {
                var n = [ b.renderTimestamp(new Date()) + ":  " ].concat(e);
                b.doLog(n);
            }
        ...
        b.allocateGuid = function() {
            ...
            return u = {
                ...
                fire: function() {
                    ...
                    if (e && !u.destroyed) {
                        b.passLogLevel(b.logLevel.TRACE) && b.log(b.logLevel.TRACE, "Firing event " + i + " to list of " + e.length + " listeners");
                        for (var t = 0; t < e.length; ++t) {
                            var n = e[t];
                            n.listener = b.event.resolveListener(n.listener);
        ...
        b.computeDynamicComponents = b.identity, b.mergeRecordTypes = {
            ...
            var s = {}, l = [], c = [], d = {
                ...
                }), b.sortByPriority(u), b.dedupeDistributionNamespaces(u), l.length = 0, c.length = 0, 
                b.each(u, function(e) {
                    l.push(e.strategy), c.push(e.target);
                });
            };
            f();
            var p, m, g = b.makeMergeOptions(i, c, d);
            function h() {
                m = b.driveStrategy(s, "mergePolicy", g.strategy), m = y.extend({}, b.rootMergePolicy, m), 
                p = b.compileMergePolicy(m), y.extend(!0, i, p.builtins);
            }
            g.mergeBlocks = u, g.updateBlocks = f, g.destroyValue = function(e) {
                for (var t = 0; t < u.length; ++t) u[t].immutableTarget || b.destroyValue(u[t].target, e);
                b.destroyValue(d.target, e);
            ...
            }, e, {})), f()) : b.fail("Cannot operate mergePolicy ", m, " for component ", e, " without including FluidIoC.js")), 
            e.options = s, b.driveStrategy(s, "gradeNames", g.strategy), b.deliverOptionsStrategy(e, s, g), 
            b.computeComponentAccessor(e, n && n.localRecord);
            var v = b.driveStrategy(s, "transformOptions", g.strategy);
            return v && (b.transformOptionsBlocks(u, v, [ "user", "subcomponentRecord" ]), f()), 
    ...
    !function(r, d) {
        ...
        h.visitComponentChildren = function(e, t, n, r) {
            ...
            var o = h.parseSelector(t, h.IoCSSMatcher), i = [];
            return h.visitComponentsForMatching(e, {
                flat: n
            }, function(e, t, n, r, a) {
                h.matchIoCSelector(o, t, n, r, a) && i.push(e);
            }), i;
        ...
        h.filterBuiltinGrades = function(e) {
            ...
            return d.extend(c, {
                ...
                }), h.clearDistributions(a.childShadow), h.clearListeners(a.childShadow), h.fireEvent(a.child, "afterDestroy", [ a.child, a.name, a.component ]), 
                delete c.idToShadow[a.child.id];
        ...
        h.fabricateDestroyMethod = function(e, t, n, r) {
            ...
            var s = h.preExpand(i.args), l = {}, c = h.makeStackResolverOptions(r, l, !0), e = function() {
        ...
        y.clearLinkCounts = function(n, r) {
            ...
            if ("string" == typeof n) if (y.isIoCReference(n)) {
                var l = (a = y.parseModelReference(e, n)).segs.indexOf("model");
                -1 === l ? r ? a.nonModel = !0 : u(' must be a reference into a component model via a path including the segment "model"') : (a.modelSegs = a.segs.slice(l + 1), 
                a.contextSegs = a.segs.slice(0, l), delete a.path);
            } else a = {
                path: n,
            ...
            return i = a.context ? ((o = y.resolveContext(a.context, e)) || u(" context must be a reference to an existing component"), 
            a.contextSegs ? y.getForComponent(o, a.contextSegs) : o) : e, a.nonModel || (y.isComponent(i) || s(i), 
            i.applier || y.getForComponent(i, [ "applier" ]), i.applier || s(i)), a.that = i, 
            a.applier = i && i.applier, a.path || (a.path = i && i.applier.composeSegments.apply(null, a.modelSegs)), 
            a;
            ...
            var n = function(e, t, n, r, a, o) {
                ...
                var s = u[v];
                u[f] = u[f] || 0;
                ++u[f], u[f] > y.relayRecursionBailout && y.fail("Error in model relay specification at component ", l, " - operated more than " + y.relayRecursionBailout + " relays without model value settling - current model contents are ", a.newHolder.model), 
    ...
    !function(s, l) {
        ...
        if (!e.Filter) {
            ...
            t.prototype.filter = function(e, t) {
                ...
                if (3 == i && 2 == a) for (var g, h, v = o[0], y = o[1], b = o[2], k = r[0], S = r[1], x = t[n - 1], C = t[n - 2], A = e[n - 1], w = e[n - 2]; n < l; ++n) g = C, 
                C = x, h = w, A = v * (x = t[n]) + y * C + b * g - k * (w = A) - S * h, e[n] = A; else for (;n < l; ++n) {
                    var I;
                    m = o[0] * t[n];
        ...
        if (!e.FFT) {
            var b = function(e, t, n, r, a, o, i, u, s, l, c, d, f, p) {
                ...
                switch (n = h, m) {
                  ...
                  case 3:
                    !function(e, t, n, r, a, o, i) {
                        for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C = 0, A = 0, w = 2 * r, I = n, N = n + i, M = n + 2 * i, P = o[r * i], O = .5773502691896258, T = I + i; I < T; ) g = e[I] * O, 
                        h = t[I] * O, v = e[N] * O, y = t[N] * O, b = e[M] * O, k = t[M] * O, S = a[C], 
                  ...
                  case 4:
                    !function(e, t, n, r, a, o, i, u) {
                        for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, O = 0, T = 0, V = 0, L = 2 * r, D = 3 * r, R = n, F = n + i, E = n + 2 * i, G = n + 3 * i, B = R + i; R < B; ) k = .5 * e[R], 
                        S = .5 * t[R], x = .5 * e[F], C = .5 * t[F], A = .5 * e[E], w = .5 * t[E], I = .5 * e[G], 
                        N = .5 * t[G], s = x * (M = a[O]) - C * (P = o[O]), l = x * P + C * M, y = k - (c = A * (M = a[T]) - w * (P = o[T])), 
                        b = S - (d = A * P + w * M), k += c, S += d, m = s + (f = I * (M = a[V]) - N * (P = o[V])), 
                        g = l + (p = I * P + N * M), h = s - f, v = l - p, e[E] = k - m, t[E] = S - g, e[R] = k + m, 
                        t[R] = S + g, t[G] = u ? (e[F] = y - v, t[F] = b + h, e[G] = y + v, b - h) : (e[F] = y + v, 
                        t[F] = b - h, e[G] = y - v, b + h), O += r, T += L, V += D, ++R, ++F, ++E, ++G;
                    }(e, t, n, i, c, d, g, p);
                    break;

                  case 5:
                    !function(e, t, n, r, a, o, i) {
                        for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, O, T, V, L, D, R, F, E, G, B, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) L = e[X] * ue, 
                        D = t[X] * ue, R = e[Z] * ue, F = t[Z] * ue, E = e[ee] * ue, G = t[ee] * ue, B = e[te] * ue, 
                        q = t[te] * ue, _ = e[ne] * ue, U = t[ne] * ue, u = L, s = D, l = R * (j = a[z]) - F * (W = o[z]), 
                        c = R * W + F * j, d = E * (j = a[H]) - G * (W = o[H]), f = E * W + G * j, p = B * (j = a[K]) - q * (W = o[K]), 
                        m = B * W + q * j, S = l + (g = _ * (j = a[J]) - U * (W = o[J])), x = c + (h = _ * W + U * j), 
                        N = l - g, M = c - h, C = d + p, A = f + m, w = d - p, I = f - m, e[X] = L + S + C, 
                        t[X] = D + x + A, v = u + S * re + C * oe, y = s + x * re + A * oe, b = M * ae + I * ie, 
                        k = -N * ae - w * ie, e[Z] = v - b, t[Z] = y - k, e[ne] = v + b, t[ne] = y + k, 
                        P = u + S * oe + C * re, O = s + x * oe + A * re, T = -M * ie + I * ae, V = N * ie - w * ae, 
                        e[ee] = P + T, t[ee] = O + V, e[te] = P - T, t[te] = O - V, z += r, H += $, K += Y, 
                        J += Q, ++X, ++Z, ++ee, ++te, ++ne;
                    }(e, t, n, i, c, d, g);
                    break;
                    ...
                    !function(e, t, n, r, a, o, i, u, s) {
                        ...
                        for (l = 0; l < i; ++l) {
                            ...
                            for (c = 0; c < u; ++c) {
                                p = b[0], m = k[0];
                                var C = 0;
                                for (d = 1; d < u; ++d) s <= (C += x) && (C -= s), g = b[d], h = k[d], p += g * (v = a[C]) - h * (y = o[C]), 
                                m += g * y + h * v;
                                e[f] = p, t[f] = m, f += i, x += r;
                            }
                        }
    ...
    a.prototype.init_genrand = function(e) {
    ...
    }, a.prototype.init_by_array = function(e, t) {
        var n, r, a;
    ...
    }, a.prototype.LOG4 = Math.log(4), a.prototype.SG_MAGICCONST = 1 + Math.log(4.5), 
    a.prototype.exponential = function(e) {
        if (1 != arguments.length) throw new SyntaxError("exponential() must  be called with 'lambda' parameter");
        var t = this.random();
        return -Math.log(t) / e;
    }, a.prototype.gamma = function(e, t) {
    ...
    }, a.prototype.normal = function(e, t) {
    ...
    }, a.prototype.uniform = function(e, t) {
    ...
    }, a.prototype.weibull = function(e, t) {
    ...
    !function() {
        ...
        if (V.fluid = m, V.init = function(e) {
            var t = e ? {
                components: {
                    audioSystem: {
                        options: {
            ...
            return V.enviro(t);
        }, V.ALL_CHANNELS = 32, V.OUT_UGEN_ID = "flocking-out", V.PI = Math.PI, V.TWOPI = 2 * Math.PI, 
        V.HALFPI = Math.PI / 2, V.LOG01 = Math.log(.1), V.LOG001 = Math.log(.001), V.ROOT2 = Math.sqrt(2), 
        V.rates = {
            AUDIO: "audio",
            CONTROL: "control",
            SCHEDULED: "scheduled",
            DEMAND: "demand",
            CONSTANT: "constant"
        }, m.registerNamespace("flock.debug"), V.debug.failHard = !0, V.browser = function() {
            ...
            r;
        }, m.registerNamespace("flock.platform"), V.platform.isBrowser = "undefined" != typeof window, 
        V.platform.hasRequire = "undefined" != typeof require, V.platform.os = V.platform.isBrowser ? window.navigator.platform : require("os").platform(), 
        V.platform.isLinux = -1 < V.platform.os.indexOf("Linux"), V.platform.isAndroid = V.platform.isLinux && -1 < V.platform.os.indexOf("arm"), 
        V.platform.isIOS = "iPhone" === V.platform.os || "iPad" === V.platform.os || "iPod" === V.platform.os, 
        V.platform.isMobile = V.platform.isAndroid || V.platform.isIOS, V.platform.browser = V.browser(), 
        V.platform.isWebAudio = "undefined" != typeof AudioContext || "undefined" != typeof webkitAudioContext, 
        V.platform.audioEngine = V.platform.isBrowser ? "webAudio" : "nodejs", V.platform.browser && void 0 !== V.platform.browser.version) {
            var e = V.platform.browser.version.indexOf(".");
            V.platform.browser.majorVersionNumber = Number(e < 0 ? V.platform.browser.version : V.platform.browser.version.substring(0, e));
        }
        V.shim = {
            URL: V.platform.isBrowser ? window.URL || window.webkitURL || window.msURL : void 0
        }, V.requireModule = function(e, t) {
            if (V.platform.isBrowser) return window[t || e];
            if (V.platform.hasRequire) {
                var n = V.requireModule.paths[e] || e, r = require(n);
                return t ? r[t] : r;
            }
        }, V.requireModule.paths = {
            webarraymath: "../third-party/webarraymath/js/webarraymath.js",
            Random: "../third-party/simjs/js/random-0.26.js"
        }, V.noOp = function() {}, V.isIterable = function(e) {
            var t = typeof e;
            return e && void 0 !== e.length && "string" !== t && "function" !== t;
        }, V.hasValue = function(e, t) {
            var n = !1;
            ...
            return n;
        }, V.hasTag = function(e, t) {
            return !(!e || !t) && (e.tags && -1 < e.tags.indexOf(t));
        }, V.randomValue = function(e, t) {
            var n = t - e;
            return Math.random() * n + e;
        }, V.randomAudioValue = function() {
            return 2 * Math.random() - 1;
        }, V.fillBuffer = function(e, t) {
            for (var n = 0; n < e.length; n++) e[n] = t(n, e);
            return e;
        }, V.fillBufferWithValue = function(e, t) {
            for (var n = 0; n < e.length; n++) e[n] = t;
            return e;
        }, V.generateBuffer = function(e, t) {
            var n = new Float32Array(e);
            return V.fillBuffer(n, t);
        }, V.generateBufferWithValue = function(e, t) {
            var n = new Float32Array(e);
            return V.fillBufferWithValue(n, t);
        }, V.generate = function(e, t) {
            var n = "number" == typeof e;
            return ("function" == typeof t ? n ? V.generateBuffer : V.fillBuffer : n ? V.generateBufferWithValue : V.fillBufferWithValue)(e, t);
        }, V.generate.silence = function(e) {
            return new Float32Array(e);
        }, V.clearBuffer = function(e) {
            for (var t = 0; t < e.length; t++) e[t] = 0;
            return e;
        }, V.reverse = function(e) {
            if (!e || !V.isIterable(e) || e.length < 2) return e;
            if ("function" == typeof e.reverse) return e.reverse();
            for (var t, n = 0, r = e.length - 1; n < r; n++, r--) t = e[n], e[n] = e[r], e[r] = t;
            return e;
        }, V.randomIndex = function(e) {
            var t = e.length - 1;
            return Math.round(Math.random() * t);
        }, V.arrayChoose = function(e, t) {
            return t = t || V.randomIndex, (e = m.makeArray(e))[t(e)];
        }, V.choose = function(e, t) {
            return V.isIterable(e) ? V.arrayChoose(e, t) : e[V.arrayChoose(e.keys, t)];
            ...
            return e;
        }, V.normalize = function(e, t, n) {
            n = n || e;
            var r, a, o, i = 0;
            for (t = void 0 === t ? 1 : t, r = 0; r < e.length; r++) i < (a = Math.abs(e[r])) && (i = a);
            if (0 < i) for (r = 0; r < e.length; r++) o = e[r], n[r] = o / i * t;
            return n;
        }, V.generateFourierTable = function(e, o, i, u, s) {
            return u *= V.TWOPI, V.generateBuffer(e, function(e) {
                var t, n, r, a = 0;
                for (t = 0; t < i; t++) n = s ? s[t] : 1, r = (t + 1) * (e * o), a += n * Math.cos(r + u);
                return a;
            });
        }, V.generateNormalizedFourierTable = function(e, t, n, r, a) {
            var o = V.generateBuffer(n, function(e) {
                return a(e + 1);
            }), i = V.generateFourierTable(e, t, n, r, o);
            return V.normalize(i);
        }, V.fillTable = function(e, t) {
            var n = "number" == typeof e ? e : e.length;
            return t(e, V.TWOPI / n);
        }, V.tableGenerators = {
            sin: function(e, t) {
                return V.generateBuffer(e, function(e) {
                    return Math.sin(e * t);
                });
            },
            tri: function(e, t) {
                return V.generateNormalizedFourierTable(e, t, 1e3, 1, function(e) {
                    return e % 2 == 0 ? 0 : 1 / (e * e);
                });
            },
            saw: function(e, t) {
                return V.generateNormalizedFourierTable(e, t, 10, -.25, function(e) {
                    return 1 / e;
                });
            },
            square: function(e, t) {
            ...
            hann: function(n) {
                return V.generateBuffer(n, function(e) {
                    var t = Math.sin(Math.PI * e / n);
                    return t * t;
                });
            },
            sinWindow: function(t) {
                return V.generateBuffer(t, function(e) {
            ...
            if (e) {
                var t, n = V.range(e), r = (n.max - n.min) / 2, a = (n.max + n.min) / 2;
                for (t = 0; t < e.length; t++) e[t] = (e[t] - a) / r;
                return e;
            }
        }, V.copyBuffer = function(e, t, n) {
            void 0 === n && (n = e.length);
            var r, a, o = new Float32Array(n - t);
            for (r = t, a = 0; r < n; r++, a++) o[a] = e[r];
            return o;
        }, V.copyToBuffer = function(e, t) {
            for (var n = Math.min(e.length, t.length), r = 0; r < n; r++) t[r] = e[r];
        }, V.parseMidiString = function(e) {
            if (!e || e.length < 2) return NaN;
            var t = (e = e.toLowerCase()).charAt(1), n = "#" === t || "b" === t ? 2 : 1, r = e.substring(0, n);
            return 12 * Number(e.substring(n)) + V.midiFreq.noteNames[r];
        }, V.midiFreq = function(e, t, n, r) {
            return t = void 0 === t ? 440 : t, n = void 0 === n ? 69 : n, r = r || 12, "string" == typeof e && (e = V.parseMidiString(e)), 
            t * Math.pow(2, 1 * (e - n) / r);
        }, V.midiFreq.noteNames = {
            "b#": 0,
            c: 0,
            "c#": 1,
            db: 1,
            ...
            hermite: function(e, t) {
                var n = t.length, r = Math.floor(e), a = r % n, o = e - r, i = (a + 1) % n, u = (a + 2) % n, s = t[0 < a ? a - 1 : n - 1], l = t[a], c = t[i], d = .5 * (c - s), f = l - c, p = d + f, m = p + f + .5 * (t[u] - l);
                return ((m * o - (p + m)) * o + d) * o + l;
            }
        }, V.interpolate.cubic = V.interpolate.hermite, V.log = {
            fail: function(e) {
            ...
            if (V.debug.failHard) throw new Error(e);
            V.log.fail(e);
        }, V.pathParseError = function(e, t, n) {
            ...
            if (t && "" !== t) {
                ...
                for (n = 1; n < r.length; n++) {
                    if (null == a) return void V.pathParseError(e, t, r[n - 1]);
                    a = a[r[n]];
                }
                return a;
            }
            ...
            if (e && t && "" !== t) {
                ...
                for (r = 1; r < o; r++) {
                    if ("object" !== typeof (e = e[i])) return void V.fail("Error while setting a value at path '" + t + "'. A non-container object was found at segment '" + i + "'. Value: " + e);
                    void 0 === e[i = a[r]] && (e[i] = {});
                }
                return e[i] = n;
            }
        }, V.invoke = function(e, t, n) {
            var r = "function" == typeof e ? e : V.get(e, t);
            if ("function" == typeof r) return r.apply(null, n);
            V.fail("Path '" + t + "' does not resolve to a function.");
        }, V.input = {}, V.input.shouldExpand = function(e) {
            return V.parse.specialInputs.indexOf(e) < 0;
        }, V.input.pathExpander = function(e) {
        ...
        }, V.input.expandPaths = function(e) {
            var t, n, r, a = {};
            for (t in e) n = V.input.pathExpander(t), r = e[t], a[n] = r;
            return a;
        }, V.input.expandPath = function(e) {
            return "string" == typeof e ? V.input.pathExpander(e) : V.input.expandPaths(e);
        }, V.input.getValueForPath = function(e, t) {
            t = V.input.expandPath(t);
            var n = V.get(e, t);
            return V.hasTag(n, "flock.ugen.valueType") ? n.inputs.value : n;
        }, V.input.getValuesForPathArray = function(e, t) {
            var n, r, a = {};
            for (n = 0; n < t.length; n++) a[r = t[n]] = V.input.get(e, r);
            return a;
        }, V.input.getValuesForPathObject = function(e, t) {
            var n;
            for (n in t) t[n] = V.input.get(e, n);
            return t;
        }, V.input.get = function(e, t) {
            return "string" == typeof t ? V.input.getValueForPath(e, t) : V.isIterable(t) ? V.input.getValuesForPathArray(e, t) : V.input.getValuesForPathObject(e, t);
        }, V.input.resolveValue = function(e, t, n, r, a, o, i) {
            if ("string" == typeof n) {
                var u = m.extractEL(n, V.input.valueExpressionSpec);
                if (u) {
                    var s = V.input.getValueForPath(e, u);
                    return void 0 === s && V.log.debug("The value expression '" + n + "' resolved to undefined. If this isn't expected, check to ensure that your path is valid."), 
                    s;
                }
            }
            return V.input.shouldExpand(a) && i ? i(n, t, r, o) : n;
        }, V.input.valueExpressionSpec = {
            ELstyle: "${}"
        }, V.input.setValueForPath = function(e, t, n, r, a) {
            t = V.input.expandPath(t);
            var o = V.get(e, t), i = t.lastIndexOf("."), u = t.slice(i + 1), s = -1 < i ? V.get(e, t.slice(0, t.lastIndexOf(".inputs"))) : r, l = V.input.resolveValue(e, t, n, s, u, o, a);
            return V.set(e, t, l), s && s.onInputChanged && s.onInputChanged(u), l;
        }, V.input.setValuesForPaths = function(e, t, n, r) {
            var a, o, i, u = {};
            for (a in t) o = t[a], i = V.input.set(e, a, o, n, r), u[a] = i;
            return u;
        }, V.input.set = function(e, t, n, r, a) {
            return "string" == typeof t ? V.input.setValueForPath(e, t, n, r, a) : V.input.setValuesForPaths(e, t, r, a);
        ...
        }), V.audioSystem.clampNumBuses = function(e, t, n) {
            return e = Math.max(e, Math.max(n, t.min)), e = Math.min(e, t.max);
        }, V.audioSystem.defaultBufferSize = function() {
            return V.platform.isMobile ? 8192 : V.platform.browser.mozilla ? 2048 : 1024;
        ...
        }), V.busManager.acquireNextBus = function(e, t, n, r, a, o) {
            var i = r.nextAvailableBus[e];
            if (void 0 !== i) {
                var u = i + a, s = a + o;
                if ("interconnect" === e && (u += o, s = t.length), !(s <= u)) return n.change("nextAvailableBus." + e, ++i), 
                u;
                V.fail("Unable to aquire a bus. There are insufficient buses available. Please use an existing bus or configure additional buses using the enviroment's numBuses and numInputBuses parameters.");
            } else V.fail("An invalid bus type was specified when invoking flock.busManager.acquireNextBus(). Type was: " + e);
        ...
        }), V.enviro.registerGlobalSingleton = function(e) {
            e.options.isGlobalSingleton && (V.environment = V.enviro.shared = e);
        }, V.enviro.registerBuffer = function(e, t) {
            e.id && (t[e.id] = e);
        }, V.enviro.releaseBuffer = function(e, t) {
            e && delete t["string" == typeof e ? e : e.id];
        }, V.enviro.saveBuffer = function(e, t, n) {
        ...
        }, V.enviro.gen = function(e, t, n) {
            V.evaluate.clearBuses(e, t.numBuses, t.blockSize), V.evaluate.synths(n);
        }, V.enviro.start = function(e, t) {
            e.isPlaying || t();
        }, V.enviro.stop = function(e, t) {
            e.isPlaying && t();
        }, V.enviro.createAudioBuffers = function(e, t) {
            var n, r = [];
        ...
        }), V.autoEnviro.initEnvironment = function() {
            return V.environment ? V.environment : V.init();
        }, m.defaults("flock.silentEnviro", {
            gradeNames: "flock.enviro",
            listeners: {
                onCreate: [ "flock.silentEnviro.insertOutputGainNode({that})" ]
            }
        }), V.silentEnviro.insertOutputGainNode = function(e) {
        ...
        }), V.node.addToEnvironment = function(e, t, n) {
            if (void 0 === t && (t = e.options.addToEnvironment), null != t && !1 !== t) {
                var r = typeof t;
                "string" === r && "head" === t || "tail" === t ? V.nodeList[t](n, e) : "number" === r ? V.nodeList.insert(n, e, t) : V.nodeList.tail(n, e);
            }
        }, V.node.removeFromEnvironment = function(e, t) {
            V.nodeList.remove(t, e);
        }, V.node.play = function(e, t, n) {
        ...
        }), V.noteTarget.change = function(e, t, n) {
        ...
        }), V.synth.createUGenTree = function(e, t, n) {
            return new V.UGenTree(e, t, n);
        }, V.synth.calcBlockSize = function(e, t) {
            return e === V.rates.AUDIO ? t.blockSize : 1;
        }, V.synth.set = function(a, e, t, n, o) {
            return V.input.set(e, t, n, void 0, function(e, t, n, r) {
                return V.synth.ugenValueParser(a, e, r, o);
            });
        }, V.synth.input = function(e, t, n) {
            var r = e[0];
            return r ? "string" == typeof r ? e.length < 2 ? t(r) : n.apply(null, e) : V.isIterable(r) ? t(r) : n.apply(null, e) : void 0;
        }, V.synth.ugenValueParser = function(e, t, n, r) {
            if (null == t) return n;
            var a, o, i, u = V.parse.ugenDef(t, e.enviro, {
                audioSettings: e.audioSettings,
                buses: e.enviro.busManager.buses,
                buffers: e.enviro.buffers
            }), s = V.isIterable(u) ? u : void 0 !== u ? [ u ] : [], l = V.isIterable(n) ? n : void 0 !== n ? [ n ] : [], c = Math.min(s.length, l.length), d = r ? "swapTree" : "replaceTree";
            for (a = 0; a < c; a++) o = V.ugenNodeList[d](e.nodeList, s[a], l[a]);
            for (i = a; i < s.length; i++) o++, V.ugenNodeList.insertTree(e.nodeList, s[i], o);
            for (i = a; i < l.length; i++) V.ugenNodeList.removeTree(e.nodeList, l[i]);
            return u;
    ...
    !function() {
        ...
        V.nodeList = function() {
        ...
        }, V.nodeList.insert = function(e, t, n) {
            return n < 0 && (n = 0), e.nodes.splice(n, 0, t), V.nodeList.registerNode(e, t), 
            n;
        }, V.nodeList.registerNode = function(e, t) {
            var n = t.name || t.id;
            n && (e.namedNodes[n] = t);
        }, V.nodeList.head = function(e, t) {
            return V.nodeList.insert(e, t, 0);
        }, V.nodeList.before = function(e, t, n) {
            var r = e.nodes.indexOf(n);
            return V.nodeList.insert(e, t, r);
        }, V.nodeList.after = function(e, t, n) {
            var r = e.nodes.indexOf(n) + 1;
            return V.nodeList.insert(e, t, r);
        }, V.nodeList.tail = function(e, t) {
            var n = e.nodes.length;
            return V.nodeList.insert(e, t, n);
        }, V.nodeList.unregisterNode = function(e, t) {
            var n = t.name || t.id;
            n && delete e.namedNodes[n];
        }, V.nodeList.isNodeActive = function(e, t) {
            return -1 < e.nodes.indexOf(t);
        }, V.nodeList.remove = function(e, t) {
            if (e) {
                var n = e.nodes.indexOf(t);
                return -1 < n && (e.nodes.splice(n, 1), V.nodeList.unregisterNode(e, t)), n;
            }
        }, V.nodeList.replace = function(e, t, n) {
            var r = e.nodes.indexOf(n);
            return r < 0 ? V.nodeList.tail(e, t) : (e.nodes[r] = t, V.nodeList.unregisterNode(e, n), 
            V.nodeList.registerNode(e, t), r);
        }, V.nodeList.clearAll = function(e) {
            for (var t in e.nodes.length = 0, e.namedNodes) delete e.namedNodes[t];
        }, V.ugenNodeList = function() {
            return V.nodeList();
        }, V.ugenNodeList.insertTree = function(e, t, n) {
            var r, a, o = t.inputs;
            for (r in o) a = o[r], V.isUGen(a) && (n = V.ugenNodeList.insertTree(e, a, n), n++);
            return V.nodeList.insert(e, t, n);
        }, V.ugenNodeList.removeTree = function(e, t) {
            var n, r, a = t.inputs;
            for (n in a) r = a[n], V.isUGen(r) && V.ugenNodeList.removeTree(e, r);
            return V.nodeList.remove(e, t);
        }, V.ugenNodeList.tailTree = function(e, t) {
            var n = e.nodes.length;
            return V.ugenNodeList.insertTree(e, t, n);
        }, V.ugenNodeList.replaceTree = function(e, t, n) {
            if (!n) return V.ugenNodeList.tailTree(e, t);
            var r = V.ugenNodeList.removeTree(e, n);
            return V.ugenNodeList.insertTree(e, t, r), r;
        }, V.ugenNodeList.swapTree = function(e, t, n, r) {
            return r ? (V.ugenNodeList.reattachInputs(e, t, n, r), V.ugenNodeList.replaceInputs(e, t, n, r)) : t.inputs = n.inputs, 
            V.nodeList.replace(e, t, n);
        }, V.ugenNodeList.reattachInputs = function(e, t, n, r) {
            for (var a in n.inputs) r.indexOf(a) < 0 ? V.ugenNodeList.removeTree(e, n.inputs[a]) : t.inputs[a] = n.inputs[a];
        }, V.ugenNodeList.replaceInputs = function(e, t, n, r) {
            for (var a in t.inputs) r.indexOf(a) < 0 && V.ugenNodeList.replaceTree(e, t.inputs[a], n.inputs[a]);
        }, V.makeUGens = function(e, t, n, r, a) {
            ...
            var o = t === V.rates.SCHEDULED || t === V.rates.DEMAND;
            return V.parse.synthDef(e, r, {
                rate: t,
                overrideRate: o,
                visitors: [ V.makeUGens.visitor(n) ],
                buffers: r.buffers,
                buses: r.busManager.buses,
                audioSettings: a || r.audioSystem.model
            });
        }, V.makeUGens.visitor = function(t) {
            return function(e) {
                V.nodeList.tail(t, e);
            };
        };
    ...
    !function() {
        ...
        V.evaluate = {
            ...
            synthValue: function(e) {
                return V.evaluate.synth(e), e.model.value;
            },
            synths: function(e) {
                for (var t = 0; t < e.length; t++) V.evaluate.synth(e[t]);
            },
    ...
    !function() {
        ...
        }), V.modelSynth.updateUGens = function(e, t, n) {
            var r = {};
            V.modelSynth.flattenModel("", n.value, r), e(r);
        }, V.modelSynth.shouldFlattenValue = function(e) {
            return m.isPrimitive(e) || V.isIterable(e) || e.ugen;
        }, V.modelSynth.flattenModel = function(e, t, n) {
            for (var r in t) {
                var a = t[r], o = m.pathUtil.composePath(e, r.toString());
                V.modelSynth.shouldFlattenValue(a) ? n[o] = a : V.modelSynth.flattenModel(o, a, n);
            }
            return n;
        };
    }();
    ...
    !function() {
        ...
        }), V.synth.group.head = function(e, t) {
            V.nodeList.head(t.nodeList, e), t.events.onInsert.fire(e);
        }, V.synth.group.tail = function(e, t) {
            V.nodeList.tail(t.nodeList, e), t.events.onInsert.fire(e);
        }, V.synth.group.insert = function(e, t, n) {
            V.nodeList.insert(n.nodeList, e, t), n.events.onInsert.fire(e);
        }, V.synth.group.before = function(e, t, n) {
            V.nodeList.before(n.nodeList, e, t), n.events.onInsert.fire(e);
        }, V.synth.group.after = function(e, t, n) {
            V.nodeList.after(n.nodeList, e, t), n.events.onInsert.fire(e);
        }, V.synth.group.removeNodeFromEnvironment = function(e) {
            e.removeFromEnvironment();
        }, V.synth.group.get = function(e, t) {
            var n = t[t.length - 1];
            return n.get.apply(n, e);
        }, V.synth.group.input = function(e, t, n) {
            return (1 < e.length ? n : t).apply(null, e);
        }, V.synth.group.bindMethods = function(e, t, n, r) {
            for (var a in t) {
                var o = e[t[a]];
                (0, n[a][r])(o);
            }
    ...
    !function() {
        ...
        }), V.synth.polyphonic.noteChange = function(e, t, n, r) {
            var a = e.options.noteChanges[t], o = i.extend({}, a, r);
            n.set(o);
        }, V.synth.polyphonic.noteOn = function(e, t, n) {
        ...
        }, V.synth.polyphonic.noteOff = function(e, t, n) {
        ...
        }), V.synth.voiceAllocator.createVoice = function(e, t) {
            var n, r = V.synth({
                synthDef: e.synthDef,
                addToEnvironment: !1
        ...
        }), V.synth.voiceAllocator.lazy.get = function(e, t, n, r) {
        ...
        }), V.synth.voiceAllocator.pool.get = function(e) {
            if (0 < e.length) return e.pop();
        }, V.synth.voiceAllocator.pool.allocateVoices = function(e, t, n) {
    ...
    !function() {
        ...
        m.defaults("flock.promise", {
        ...
        }), V.promise.make = function() {
            return new e();
        }, V.bufferDesc = function(e, t, n) {
            return (V.platform.isWebAudio && e instanceof AudioBuffer ? V.bufferDesc.fromAudioBuffer : V.isIterable(e) ? V.bufferDesc.fromChannelArray : V.bufferDesc.expand)(e, t, n);
        }, V.bufferDesc.inferFormat = function(e, t, n) {
        ...
        }, V.bufferDesc.fromChannelArray = function(e, t, n) {
            ...
            return V.bufferDesc.inferFormat(r, t, n);
        }, V.bufferDesc.expand = function(e, t, n) {
            if ((e = e || {
                data: {
                    channels: []
                }
            ...
            return V.bufferDesc.inferFormat(e, t, n);
        }, V.bufferDesc.fromAudioBuffer = function(e) {
            var t, n = {
                container: {},
                format: {
            ...
            return n;
        }, V.bufferDesc.toAudioBuffer = function(e, t) {
        ...
        }), V.bufferSource.get = function(t, n) {
            ...
            "start" === t.model.state && (t.model.src = n.src, t.events.onFetch.fire(n), V.audio.decode({
                src: n.src,
        ...
        }), V.bufferLoader.idFromURL = function(e) {
            var t = e.lastIndexOf("/"), n = -1 < t ? t + 1 : 0, r = e.lastIndexOf("."), a = -1 < r ? r : e.length;
            return e.substring(n, a);
        }, V.bufferLoader.idsFromURLs = function(e) {
            return m.transform(e, V.bufferLoader.idFromURL);
        }, V.bufferLoader.expandFileSequence = function(e) {
            e = e || [];
            var t, n, r, a = [];
            for (t = 0; t < e.length; t++) n = e[t], r = V.bufferLoader.idFromURL(n), a.push({
                id: r,
                url: n
            });
            return a;
        }, V.bufferLoader.expandBufferDef = function(e) {
            return "string" == typeof e && (e = {
                url: e
            }), void 0 === e.id && void 0 !== e.url && (e.id = V.bufferLoader.idFromURL(e.url)), 
            e;
        }, V.bufferLoader.expandBufferDefs = function(e) {
            return e ? (e = m.makeArray(e), m.transform(e, V.bufferLoader.expandBufferDef)) : [];
        }, V.bufferLoader.loadBuffer = function(e, t, n) {
            try {
                V.parse.bufferForDef(e, t, n.enviro);
            } catch (e) {
                n.events.onError.fire(e.message);
            }
        }, V.bufferLoader.loadBuffers = function(n) {
            var r = 1, a = {
                setBuffer: function(e) {
                    if (n.buffers.push(e), n.buffers.length === n.options.bufferDefs.length) n.events.afterBuffersLoaded.fire(n.buffers); else if (r < n.bufferDefs.length) {
                        ...
                        V.bufferLoader.loadBuffer(t, a, n), r++;
                    }
                }
            };
            V.bufferLoader.loadBuffer(n.bufferDefs[0], a, n);
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        m.registerNamespace("flock.parse"), V.parse.synthDef = function(e, t, n) {
            return e || (e = []), V.parse.synthDef.hasOutUGen(e) || (e = V.parse.synthDef.makeOutUGenDef(e, n)), 
            V.parse.ugenForDef(e, t, n);
        }, V.parse.synthDef.hasOutUGen = function(e) {
            return !V.isIterable(e) && (e.id === V.OUT_UGEN_ID || "flock.ugen.out" === e.ugen || "flock.ugen.valueOut" === e.ugen);
        }, V.parse.synthDef.makeOutUGenDef = function(e, t) {
            return e = {
                id: V.OUT_UGEN_ID,
            ...
            }, t.rate === V.rates.AUDIO && (e.ugen = "flock.ugen.out", e.inputs.bus = 0, e.inputs.expand = t.audioSettings.chans), 
            e;
        }, V.parse.makeUGen = function(e, t, n, r) {
            var a, o = r.audioSettings.rates, i = r.audioSettings.blockSize;
            if (e.rate || (e.rate = V.rates.AUDIO), !V.hasValue(V.rates, e.rate) && (V.fail("An invalid rate was specified for a unit generator. ugenDef was: " + m.prettyPrintJSON(e)), 
            !V.debug.failHard)) {
                var u = e.rate;
                e.rate = V.rates.AUDIO, V.log.warn("Overriding invalid unit generator rate. Rate is now '" + e.rate + "'; was: " + m.prettyPrintJSON(u));
            }
            ...
            var s, l = e.rate === V.rates.AUDIO ? i : 1;
            if (V.hasTag(e.options, "flock.ugen.multiChannelOutput")) {
                var c = e.options.numOutputs || 1;
                s = [];
                for (var d = 0; d < c; d++) s.push(new Float32Array(l));
            } else s = new Float32Array(l);
            var f = m.copy(e.options);
            return f.buffers = r.buffers, f.buses = r.buses, f.enviro = n, V.invoke(void 0, e.ugen, [ t, s, f ]);
        }, V.parse.reservedWords = [ "id", "ugen", "rate", "inputs", "options" ], V.parse.specialInputs = [ "value", "buffer", "list", "table", "envelope", "durations", "values" ], 
        V.parse.expandInputs = function(e) {
            if (e.inputs) return e;
            var t, n = {};
            for (t in e) -1 === V.parse.reservedWords.indexOf(t) && (n[t] = e[t], delete e[t]);
            return e.inputs = n, e;
        }, V.parse.ugenDefForConstantValue = function(e) {
            return {
                ugen: "flock.ugen.value",
                rate: V.rates.CONSTANT,
                inputs: {
                    value: e
                }
            };
        }, V.parse.expandValueDef = function(e) {
            var t = typeof e;
            if ("number" === t) return V.parse.ugenDefForConstantValue(e);
            if ("object" === t) return e;
            throw new Error("Invalid value type found in ugen definition. UGenDef was: " + m.prettyPrintJSON(e));
        }, V.parse.rateMap = {
            ar: V.rates.AUDIO,
            kr: V.rates.CONTROL,
            sr: V.rates.SCHEDULED,
            dr: V.rates.DEMAND,
            cr: V.rates.CONSTANT
        }, V.parse.expandRate = function(e, t) {
            return e.rate = V.parse.rateMap[e.rate] || e.rate, t.overrideRate && e.rate !== V.rates.CONSTANT && (e.rate = t.rate), 
            e;
        }, V.parse.ugenDef = function(e, t, n) {
            return (V.isIterable(e) ? V.parse.ugensForDefs : V.parse.ugenForDef)(e, t, n);
        }, V.parse.ugenDef.mergeOptions = function(e) {
            var t = V.ugenDefaults(e.ugen) || {};
            return (t = m.copy(t)).options = t.ugenOptions, delete t.ugenOptions, p.extend(!0, {}, t, e);
        }, V.parse.ugensForDefs = function(e, t, n) {
            var r, a = [];
            for (r = 0; r < e.length; r++) a[r] = V.parse.ugenForDef(e[r], t, n);
            return a;
        }, V.parse.ugenForDef = function(e, t, n) {
            t = t || V.environment;
            var r = n = p.extend(!0, {
            ...
            if (e = V.parse.expandValueDef(e), V.isIterable(e)) return V.parse.ugensForDefs(e, t, n);
            e = V.parse.expandInputs(e), V.parse.expandRate(e, n);
            var i, u = (e = V.parse.ugenDef.mergeOptions(e, n)).inputs, s = {};
            for (i in u) {
                var l = u[i];
                null !== l && (s[i] = V.input.shouldExpand(i, e) ? V.parse.ugenForDef(l, t, n) : l);
            }
            ...
            var c = V.parse.makeUGen(e, s, t, n);
            if (e.id && (c.id = e.id), c.options.ugenDef = e, a) for (var d = 0; d < a.length; d++) a[d](c, e, o);
            return c;
        }, V.parse.expandBufferDef = function(e) {
            return "string" == typeof e ? {
                id: e
            } : V.isIterable(e) || e.data || e.format ? V.bufferDesc(e) : e;
        }, V.parse.bufferForDef = function(e, t, n) {
            (e = V.parse.expandBufferDef(e)).data && e.data.channels ? (e = V.bufferDesc(e), 
            V.parse.bufferForDef.resolveBuffer(e, t, n)) : V.parse.bufferForDef.resolveDef(e, t, n);
        }, V.parse.bufferForDef.createBufferSource = function(e) {
            return V.bufferSource({
                sampleRate: e.audioSystem.model.sampleRate
            });
        }, V.parse.bufferForDef.findSource = function(e, t) {
            var n;
            return t && e.id ? (n = t.bufferSources[e.id]) || (n = V.parse.bufferForDef.createBufferSource(t), 
            t.bufferSources[e.id] = n) : n = V.parse.bufferForDef.createBufferSource(t), n;
        }, V.parse.bufferForDef.bindToPromise = function(e, t, n) {
            var r = function(e) {
        ...
        }, V.parse.bufferForDef.resolveDef = function(e, t, n) {
            var r, a = V.parse.bufferForDef.findSource(e, n);
            e.src = e.url || e.src, e.selector && "undefined" != typeof document && (e.src = document.querySelector(e.selector).files[0]), 
            r = a.get(e), V.parse.bufferForDef.bindToPromise(r, a, t);
        }, V.parse.bufferForDef.resolveBuffer = function(e, t, n) {
            var r = V.parse.bufferForDef.findSource(e, n), a = r.set(e);
            V.parse.bufferForDef.bindToPromise(a, r, t);
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        V.applyDeferred = function(e, t, n) {
            e && (n = void 0 === n ? 0 : n, setTimeout(function() {
                e.apply(null, t);
            }, n));
        }, m.registerNamespace("flock.net"), V.net.readBufferFromUrl = function(e) {
            var t = e.src, n = new XMLHttpRequest();
            n.onreadystatechange = function() {
                if (4 === n.readyState) if (V.net.isXHRSuccessful(n)) e.success(n.response, V.file.parseFileExtension(t)); else {
            ...
            n.send(e.data);
        }, V.net.isXHRSuccessful = function(e) {
            return 200 === e.status || 0 === e.responseURL.indexOf("file://") && 0 === e.status && e.response;
        }, m.registerNamespace("flock.file"), V.file.mimeTypes = {
            "audio/wav": "wav",
            "audio/x-wav": "wav",
            "audio/wave": "wav",
            "audio/x-aiff": "aiff",
            ...
            aif: "aiff",
            wave: "wav"
        }, V.file.parseFileExtension = function(e) {
            var t, n = e.lastIndexOf(".");
            if (!(n < 0)) return t = (t = e.substring(n + 1)).toLowerCase(), V.file.typeAliases[t] || t;
        }, V.file.parseMIMEType = function(e) {
            return V.file.mimeTypes[e];
        }, V.file.stringToBuffer = function(e) {
            var t, n = e.length, r = new ArrayBuffer(n), a = new Uint8Array(r);
            for (t = 0; t < n; t++) a[t] = e.charCodeAt(t);
            return a.buffer;
        }, V.file.readBufferFromDataUrl = function(t) {
            ...
            i && (a = c(a)), V.applyDeferred(function() {
                var e = V.file.stringToBuffer(a);
                t.success(e, V.file.parseMIMEType(l));
            });
        }, V.file.readBufferFromFile = function(t) {
            var e = new FileReader();
            return e.onload = function(e) {
                t.success(e.target.result, V.file.parseFileExtension(t.src.name));
            }, e.readAsArrayBuffer(t.src), e;
        }, m.registerNamespace("flock.audio"), V.audio.loadBuffer = function(e) {
            var t = e.src || e.url;
            t && (t instanceof ArrayBuffer && V.applyDeferred(e.success, [ t, e.type ]), V.audio.loadBuffer.readerForSource(t)(e));
        }, V.audio.loadBuffer.readerForSource = function(e) {
            return "undefined" != typeof File && e instanceof File ? V.file.readBufferFromFile : 0 === e.indexOf("data:") ? V.file.readBufferFromDataUrl : V.net.readBufferFromUrl;
        }, V.audio.decode = function(a) {
            var o = a.success;
            a.success = function(e, t) {
                var n = V.audio.decoderStrategies, r = n[t] || n.default;
            ...
            }, V.audio.loadBuffer(a);
        }, V.audio.decode.webAudio = function(n) {
            V.webAudio.audioSystem.audioContextSingleton.decodeAudioData(n.rawData, function(e) {
                var t = V.bufferDesc.fromAudioBuffer(e);
                n.success(t);
            }, n.error);
        }, V.audio.decoderStrategies = {
            default: V.audio.decode.webAudio
        }, V.audio.registerDecoderStrategy = function(e, t) {
            if (e) if ("object" != typeof e) "string" == typeof t && (t = m.getGlobalValue(t)), 
            V.audio.decoderStrategies[e] = t; else for (var n in e) V.audio.decoderStrategies[n] = e[n];
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        for (var e in m.registerNamespace("flock.audio.convert"), V.audio.convert.maxFloatValue = function(e) {
            return 1 - 1 / e.scale;
        }, V.audio.convert.pcm = {
            int8: {
                scale: 128,
            ...
            var t = V.audio.convert.pcm[e];
            t.maxFloatValue = V.audio.convert.maxFloatValue(t);
        }
        V.audio.convert.specForPCMType = function(e) {
            var t = "string" == typeof e ? V.audio.convert.pcm[e] : e;
            return t || V.fail("Flocking does not support " + e + " format PCM wave files."), 
            t;
        }, V.audio.convert.floatToInt = function(e, t) {
            var n = Math.min(t.maxFloatValue, e);
            return n = Math.max(-1, n), n *= t.scale, n = Math.round(n);
        }, V.audio.convert.floatsToInts = function(e, t) {
            if (e) {
                for (var n = "Int" + 8 * t.width + "Array", r = new u[n](e.length), a = 0; a < e.length; a++) {
                    var o = e[a], i = V.audio.convert.floatToInt(o, t);
                    r[a] = i;
                }
                return r;
            }
        }, V.audio.convert.intToFloat = function(e, t) {
            return e / t.scale;
        }, V.audio.convert.intsToFloats = function(e, t) {
            if (e) {
                for (var n = new Float32Array(e.length), r = 0; r < e.length; r++) {
                    var a = e[r], o = V.audio.convert.intToFloat(a, t);
                    n[r] = o;
                }
                return n;
            }
    ...
    !function() {
        "use strict";
        m.registerNamespace("flock.audio.encode"), V.audio.interleave = function(e) {
            ...
            return i;
        }, V.audio.encode = function(e, t, n) {
            return "wav" !== (t = t || "wav").toLowerCase() && V.fail("Flocking currently only supports encoding WAVE files."), 
            V.audio.encode.wav(e, n);
        }, V.audio.encode.writeFloat32Array = function(e, t, n) {
            for (var r = 0; r < n.length; r++) t.setFloat32(e, n[r], !0), e += 4;
            return t;
        }, V.audio.encode.setString = function(e, t, n) {
            for (var r = 0; r < n.length; r++) e.setUint8(t + r, n.charCodeAt(r));
        }, V.audio.encode.setBytes = function(e, t, n) {
            for (var r = 0; r < n.length; r++) e.setUint8(t + r, n[r]);
        }, V.audio.encode.writeAsPCM = function(e, t, n, r) {
            if ("setFloat32" === e.setter && r instanceof Float32Array) return V.audio.encode.writeFloat32Array(t, n, r);
            for (var a = 0; a < r.length; a++) {
                var o = V.audio.convert.floatToInt(r[a], e);
                n[e.setter](t, o, !0), t += e.width;
            }
            return n;
        }, V.audio.encode.wav = function(e, t) {
            t = t || V.audio.convert.pcm.int16;
            var n = V.audio.convert.specForPCMType(t), r = V.audio.interleave(e), a = e.format.numChannels, o = e.format.sampleRate, i = "setFloat32" !== n.setter, u = 16, s = 1, l = r.length * n.width, c = 8 + l, d = n.width * a, f = 8 * n.width;
            if (2 < a || !i) {
                u += 12, s = 2 < a ? (u += 24, 65534) : (u += 2, 3);
            }
            var p = 12 + u + c, m = new ArrayBuffer(8 + p), g = new DataView(m);
            V.audio.encode.setString(g, 0, "RIFF"), g.setUint32(4, p, !0), V.audio.encode.setString(g, 8, "WAVE"), 
            V.audio.encode.setString(g, 12, "fmt "), g.setUint32(16, u, !0), g.setUint16(20, s, !0), 
            g.setUint16(22, a, !0), g.setUint32(24, o, !0), g.setUint32(28, o * d, !0), g.setUint16(32, d, !0), 
            g.setUint16(34, f, !0);
            var h = 36;
            return 3 === s ? (g.setUint16(h, 0, !0), h += 2, h = V.audio.encode.wav.writeFactChunk(g, h, e.format.numSampleFrames)) : 65534 === s && (g.setUint16(h, 22, !0), 
            h += 2, h = V.audio.encode.wav.additionalFormat(h, g, f, i), h = V.audio.encode.wav.writeFactChunk(g, h, e.format.numSampleFrames)), 
            V.audio.encode.wav.writeDataChunk(n, h, g, r, l), g.buffer;
        }, V.audio.encode.wav.subformats = {
        ...
        }, V.audio.encode.wav.additionalFormat = function(e, t, n, r) {
            t.setUint16(e, n, !0), e += 2, t.setUint32(e, 2147483648, !0), e += 4;
            var a = V.audio.encode.wav.subformats[r ? "pcm" : "float"];
            return V.audio.encode.setBytes(t, e, a), e += 16;
        }, V.audio.encode.wav.writeFactChunk = function(e, t, n) {
            return V.audio.encode.setString(e, t, "fact"), t += 4, e.setUint32(t, 4, !0), t += 4, 
            e.setUint32(t, n, !0), t += 4;
        }, V.audio.encode.wav.writeDataChunk = function(e, t, n, r, a) {
            V.audio.encode.setString(n, t, "data"), t += 4, n.setUint32(t, a, !0), t += 4, V.audio.encode.writeAsPCM(e, t, n, r);
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        V.shim = {
            ...
            }), V.shim.URL.createObjectURL(n)) : "data:text/javascript;base64," + window.btoa(e), 
            new Worker(t);
        ...
        }), V.scheduler.intervalClock.schedule = function(e, t, n) {
            var r = setInterval(function() {
                n(e);
            }, e);
            t[e] = r;
        }, V.scheduler.intervalClock.clear = function(e, t) {
            var n = t[e];
            clearInterval(n), delete t[e];
        }, V.scheduler.intervalClock.clearAll = function(e, t) {
            for (var n in e) V.scheduler.intervalClock.clear(n, e, t);
        ...
        }), V.scheduler.scheduleClock.schedule = function(e, t, n) {
            var r;
            r = setTimeout(function() {
                clearTimeout(r), n.tick.fire(e);
            }, e), t.push(r);
        }, V.scheduler.scheduleClock.clear = function(e, t, n) {
            -1 < (t = void 0 === t ? n.indexOf(e) : t) && (n.splice(t, 1), clearTimeout(e));
        }, V.scheduler.scheduleClock.clearAll = function(e) {
            for (var t = 0; t < e.length; t++) {
                var n = e[t];
                clearTimeout(n);
            }
        ...
        }), V.scheduler.addListener = function(e, t, n) {
            return t.push(e), n(e), e;
        }, V.scheduler.removeListener = function(e, t, n) {
            if (e) {
                var r = t.indexOf(e);
                -1 < r ? (t.splice(r, 1), n(e)) : e.wrappedListener && V.scheduler.removeListener(e.wrappedListener, t, n);
            }
        ...
        }), V.scheduler.repeat.intervalListeners = function(e, t) {
            return t[e];
        }, V.scheduler.repeat.addIntervalListener = function(e, t, n, r) {
            var a = V.scheduler.repeat.intervalListeners(e, n);
            V.scheduler.addListener(t, a, r);
        }, V.scheduler.repeat.removeIntervalListener = function(e, t, n, r) {
            var a = V.scheduler.repeat.intervalListeners(e, n);
            V.scheduler.removeListener(t, a, r);
        }, V.scheduler.repeat.schedule = function(e, t, n, r, a, o) {
            e = n.value(e), t = V.scheduler.async.prepareListener(t, r);
            var i = V.scheduler.repeat.wrapValueListener(e, t);
            return V.scheduler.repeat.addInterval(e, a), o(e, i), i;
        }, V.scheduler.repeat.wrapValueListener = function(t, n) {
            var e = function(e) {
                e === t && n(e);
            };
            return e.wrappedListener = n, e;
        }, V.scheduler.repeat.addInterval = function(e, t) {
            var n = t[e];
            n || (n = t[e] = []);
        }, V.scheduler.repeat.clearAll = function(e, t, n) {
            for (var r in e) V.scheduler.repeat.clearInterval(r, e, t);
            n();
        }, V.scheduler.repeat.clearInterval = function(e, t, n) {
            var r = t[e];
        ...
        }), V.scheduler.once.wrapValueListener = function(t, n, r) {
            var a = function(e) {
                e === t && (n(e), r(a));
            };
            return a.wrappedListener = n, a;
        }, V.scheduler.once.schedule = function(e, t, n, r, a, o) {
            e = n.value(e), t = V.scheduler.async.prepareListener(t, r);
            var i = V.scheduler.once.wrapValueListener(e, t, a);
            return o(e, i), i;
        }, V.scheduler.once.clearAll = function(e, t, n) {
        ...
        }), V.scheduler.async.sequence = function(e, t, n) {
            for (var r = [], a = 0; a < e.length; a++) {
                var o = n(e[a], t);
                r.push(o);
            }
            return r;
        }, V.scheduler.async.schedule = function(e, t) {
            if (e) {
                e = V.isIterable(e) ? e : [ e ];
                for (var n = 0; n < e.length; n++) {
                    var r = e[n];
                    V.invoke(t, r.interval, [ r.time, r.change ]);
                }
            }
        }, V.scheduler.async.prepareListener = function(e, t) {
            return "function" == typeof e ? e : V.scheduler.async.evaluateChangeSpec(e, t);
        }, V.scheduler.async.getTargetSynth = function(e, t) {
            var n = e.synth;
            return n ? "string" != typeof n ? n : m.get(t, n) : t;
        }, V.scheduler.async.makeSynthUpdater = function(r, a, o, i) {
            return function() {
                for (var e in r) {
                    var t = r[e];
                    o[e] = V.evaluate.synthValue(t);
                }
                var n = V.scheduler.async.getTargetSynth(a, i);
                n ? n.set(o) : V.fail("A target synth named " + a.synth + " could not be found in the specified synthContext. Synth context was: " + i);
            };
        }, V.scheduler.async.evaluateChangeSpec = function(e, t) {
            var n = {}, r = {};
            for (var a in e.values) {
                var o = e.values[a];
                o.synthDef ? n[a] = V.synth.value(o) : r[a] = o;
            }
            return V.scheduler.async.makeSynthUpdater(n, e, r, t);
        ...
        }), V.convert.seconds.toMillis = function(e) {
            return 1e3 * e;
        ...
        }), V.convert.beats.toMillis = function(e, t) {
    ...
    !function() {
        "use strict";
        m.registerNamespace("flock.webAudio"), V.webAudio.createNode = function(e, t) {
            var n = t.args ? m.makeArray(t.args) : void 0, r = "create" + t.node, a = r.indexOf("Node");
            -1 < a && (r = r.substring(0, a));
            var o = e[r].apply(e, n);
            return V.webAudio.initNodeParams(e, o, t), V.webAudio.initNodeProperties(o, t), 
            V.webAudio.initNodeInputs(o, t), o;
        }, V.webAudio.setAudioParamValue = function(e, t, n, r) {
            r = r || 0;
            var a = e.currentTime + r;
            t.setValueAtTime(n, a);
        }, V.webAudio.initNodeParams = function(e, t, n) {
            var r = n.params;
            if (t && r) {
                for (var a in r) {
                    var o = t[a], i = r[a];
                    V.webAudio.setAudioParamValue(e, o, i);
                }
                return t;
            }
        }, V.webAudio.safariPropertyProhibitions = [ "channelCount", "channelCountMode" ], 
        V.webAudio.shouldSetProperty = function(e) {
            return !V.platform.browser.safari || V.webAudio.safariPropertyProhibitions.indexOf(e) < 0;
        }, V.webAudio.initNodeProperties = function(e, t) {
            var n = t.props;
            if (n) {
                for (var r in n) {
                    var a = n[r];
                    V.webAudio.shouldSetProperty(r) && (e[r] = a);
                }
                return e;
            }
        }, V.webAudio.connectInput = function(e, t, n, r) {
            n.connect(e, r, t);
        }, V.webAudio.initNodeInputs = function(e, t) {
            var n = t.inputs;
            for (var r in n) {
        ...
        }), V.webAudio.outputFader.createGainNode = function(e, t) {
            return e.createOutputNode(t);
        }, V.webAudio.outputFader.fade = function(e, t, n, r, a) {
            a = a || 0;
            var o = e.currentTime + a;
            V.webAudio.setAudioParamValue(e, t.gain, n), t.gain.linearRampToValueAtTime(r, o);
        }, V.webAudio.outputFader.fadeTo = function(e, t, n, r) {
            V.webAudio.outputFader.fade(e, t, t.gain.value, n, r);
        }, V.webAudio.outputFader.fadeIn = function(e, t, n, r) {
            V.webAudio.outputFader.fade(e, t, 0, n, r);
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        }), V.webAudio.audioSystem.createContext = function() {
            var e = V.webAudio.audioSystem;
            return e.audioContextSingleton || (e.audioContextSingleton = new V.shim.AudioContext()), 
            e.audioContextSingleton;
        }, V.webAudio.audioSystem.calcMaxChannels = function(e) {
            return V.platform.browser.safari ? e.channelCount : e.maxChannelCount;
        }, V.webAudio.audioSystem.calcMinChannels = function() {
            return V.platform.browser.safari ? 2 : 1;
        }, V.webAudio.audioSystem.configureDestination = function(e, t) {
            V.platform.browser.safari || (e.destination.channelCount = t, e.destination.channelCountMode = "explicit", 
    ...
    !function() {
        ...
        }), V.webAudio.bufferWriter.saveBuffer = function(t) {
            try {
                var e = V.audio.encode.wav(t.buffer, t.format), n = new Blob([ e ], {
                    type: "audio/wav"
                });
                return V.webAudio.bufferWriter.download(t.path, n), t.success && t.success(e), e;
            } catch (e) {
                t.error ? t.error(e) : V.fail("There was an error while trying to download the buffer named " + t.buffer.id + ". Error: " + e);
            }
        }, V.webAudio.bufferWriter.download = function(e, t) {
            var n = V.shim.URL.createObjectURL(t), r = window.document.createElement("a"), a = document.createEvent("Event");
    ...
    !function() {
        "use strict";
        m.registerNamespace("flock.webAudio.chrome"), V.webAudio.chrome.getSources = function(n) {
        ...
        }, V.webAudio.mediaStreamFailure = function() {
            V.fail("Media Capture and Streams are not supported on this browser.");
        };
        var e = {
            AudioContext: window.AudioContext || window.webkitAudioContext,
            getUserMediaImpl: navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia || V.webAudio.mediaStreamFailure,
            getUserMedia: function() {
                V.shim.getUserMediaImpl.apply(navigator, arguments);
            },
            getMediaDevicesImpl: navigator.getMediaDevices ? navigator.getMediaDevices : void 0 !== window.MediaStreamTrack ? V.webAudio.chrome.getSources : V.webAudio.mediaStreamFailure,
            getMediaDevice: function() {
                V.shim.getMediaDevicesImpl.apply(navigator, arguments);
            }
        };
        t.extend(V.shim, e), m.defaults("flock.webAudio.inputDeviceManager", {
            gradeNames: [ "fluid.component" ],
            invokers: {
                openAudioDevice: {
        ...
        }), V.webAudio.inputDeviceManager.openAudioDevice = function(e, t, n, r) {
            if (e) {
                if (e.id) return t(e.id);
                if (e.label) return n(e.label);
            }
            return r();
        }, V.webAudio.inputDeviceManager.openAudioDeviceWithId = function(e, t) {
            t({
                audio: {
                    optional: [ {
                        sourceId: e
        ...
        }, V.webAudio.inputDeviceManager.openFirstAudioDeviceWithLabel = function(n, r) {
            n && V.shim.getMediaDevices(function(e) {
        ...
        }, V.webAudio.inputDeviceManager.openAudioDeviceWithConstraints = function(e, t, n, r) {
            r = r || {
                audio: !0
            };
            var a = t.busManager.acquireNextBus("input");
            return V.shim.getUserMedia(r, function(e) {
                n(e, a);
            }, function(e) {
    ...
    !function() {
        "use strict";
        m.registerNamespace("flock.midi"), V.midi.requestAccess = function(e, t, n) {
        ...
        }, V.midi.getPorts = function(e) {
            var t = {}, n = "function" == typeof e.inputs ? V.midi.collectPortsLegacy : V.midi.collectPorts;
            return n("inputs", e, t), n("outputs", e, t), t;
        }, V.midi.requestPorts = function(n, e) {
            V.midi.requestAccess(!1, function(e) {
                var t = V.midi.getPorts(e);
                n(t);
            }, e);
        }, V.midi.createPortViews = function(e) {
        ...
        }, V.midi.prettyPrintPorts = function(e) {
            return m.prettyPrintJSON({
                inputs: V.midi.createPortViews(e.inputs),
                outputs: V.midi.createPortViews(e.outputs)
            });
        }, V.midi.logPorts = function() {
            V.midi.requestPorts(function(e) {
                var t = V.midi.prettyPrintPorts(e);
                console.log(t);
            }, function(e) {
                console.log(e);
            });
        }, V.midi.collectPorts = function(e, t, n) {
            for (var r = n[e] = n[e] || [], a = t[e].values(), o = a.next(); !o.done; ) r.push(o.value), 
            o = a.next();
            return n;
        }, V.midi.collectPortsLegacy = function(e, t, n) {
            return t[e] && (n[e] = t[e]()), n;
        }, V.midi.read = function(e) {
            var t, n = e[0], r = 15 & n;
            switch (n >> 4) {
              case 8:
                t = V.midi.read.noteOff;
                break;

              case 9:
                t = 0 < e[2] ? V.midi.read.noteOn : V.midi.read.noteOff;
                break;

              case 10:
                t = V.midi.read.polyAftertouch;
                break;

              case 11:
                t = V.midi.read.controlChange;
                break;

              case 12:
                t = V.midi.read.programChange;
                break;

              case 13:
                t = V.midi.read.channelAftertouch;
                break;

              case 14:
                t = V.midi.read.pitchbend;
                break;

              case 15:
                t = V.midi.read.system;
                break;

              default:
                return V.fail("Received an unrecognized MIDI message: " + m.prettyPrintJSON(e));
            }
            return t(r, e);
        }, V.midi.read.note = function(e, t, n) {
            return {
                type: e,
                chan: t,
                note: n[1],
        ...
        }, V.midi.read.noteOn = function(e, t) {
            return V.midi.read.note("noteOn", e, t);
        }, V.midi.read.noteOff = function(e, t) {
            return V.midi.read.note("noteOff", e, t);
        }, V.midi.read.polyAftertouch = function(e, t) {
            return {
                type: "aftertouch",
                chan: e,
                note: t[1],
        ...
        }, V.midi.read.controlChange = function(e, t) {
            return {
                type: "control",
                chan: e,
                number: t[1],
        ...
        }, V.midi.read.programChange = function(e, t) {
            return {
                type: "program",
                chan: e,
                program: t[1]
            };
        }, V.midi.read.channelAftertouch = function(e, t) {
            return {
                type: "aftertouch",
                chan: e,
                pressure: t[1]
            };
        }, V.midi.read.twoByteValue = function(e) {
            return e[2] << 7 | e[1];
        }, V.midi.read.pitchbend = function(e, t) {
            return {
                type: "pitchbend",
                chan: e,
                value: V.midi.read.twoByteValue(t)
            };
        }, V.midi.read.system = function(e, t) {
            if (1 === e) return V.midi.messageFailure("quarter frame MTC");
            var n;
            switch (e) {
              case 0:
                n = V.midi.read.sysex;
              ...
              case 2:
                n = V.midi.read.songPointer;
                break;

              case 3:
                n = V.midi.read.songSelect;
                break;

              case 6:
                n = V.midi.read.tuneRequest;
                break;
              ...
              default:
                return V.fail("Received an unrecognized MIDI system message: " + m.prettyPrintJSON(t));
            }
            return n(t);
        }, V.midi.messageFailure = function(e) {
            V.fail("Flocking does not currently support MIDI " + e + " messages.");
        }, V.midi.read.sysex = function(e) {
            return {
                type: "sysex",
                data: e
            };
        }, V.midi.read.valueMessage = function(e, t) {
            return {
                type: e,
                value: t
            };
        }, V.midi.read.songPointer = function(e) {
            var t = V.midi.read.twoByteValue(e);
            return V.midi.read.valueMessage("songPointer", t);
        }, V.midi.read.songSelect = function(e) {
            return V.midi.read.valueMessage("songSelect", e[1]);
        }, V.midi.read.tuneRequest = function() {
            return {
                type: "tuneRequest"
            };
        }, V.midi.systemRealtimeMessages = [ "tuneRequest", "clock", "start", "continue", "stop", "activeSense", "reset" ], 
        V.midi.createSystemRealtimeMessageReaders = function(e) {
            m.each(e, function(e) {
                V.midi.read[e] = function() {
                    return {
                        type: e
                    };
                };
            });
        }, V.midi.createSystemRealtimeMessageReaders(V.midi.systemRealtimeMessages), m.defaults("flock.midi.system", {
            gradeNames: [ "fluid.component" ],
            sysex: !1,
            members: {
                access: void 0,
        ...
        }), V.midi.system.setAccess = function(e, t) {
            e.access = t;
        }, V.midi.system.refreshPorts = function(e, t, n) {
            e.ports = V.midi.getPorts(t), n(e.ports);
        ...
        }), V.midi.connection.send = function() {
            V.fail("Sending MIDI messages is not currently supported.");
        }, V.midi.connection.autoOpen = function(e, t) {
            e && t();
        }, V.midi.findPorts = function(n, e) {
            e = m.makeArray(e);
            var r = [];
            return m.each(e, function(e) {
                var t = V.midi.findPorts.portFinder(e)(n);
                r = r.concat(t);
            }), r;
        }, V.midi.findPorts.portFinder = function(e) {
            if ("number" == typeof e) return V.midi.findPorts.byIndex(e);
            "string" == typeof e && (e = {
                name: e
            });
            var t = e.id ? V.midi.findPorts.idMatcher(e.id) : e.manufacturer && e.name ? V.midi.findPorts.bothMatcher(e.manufacturer, e.name) : e.manufacturer ? V.midi.findPorts.manufacturerMatcher(e.manufacturer) : V.midi.findPorts.nameMatcher(e.name);
            return function(e) {
                return e.filter(t);
            };
        }, V.midi.findPorts.byIndex = function(n) {
            return function(e) {
                var t = e[n];
                return t ? [ t ] : [];
            };
        }, V.midi.findPorts.lowerCaseContainsMatcher = function(o) {
            return function(e) {
                var t;
                for (var n in o) {
                    var r = e[n], a = o[n];
        ...
        }, V.midi.findPorts.idMatcher = function(t) {
            return function(e) {
                return e.id === t;
            };
        }, V.midi.findPorts.bothMatcher = function(e, t) {
            return V.midi.findPorts.lowerCaseContainsMatcher({
                manufacturer: e,
                name: t
            });
        }, V.midi.findPorts.manufacturerMatcher = function(e) {
            return V.midi.findPorts.lowerCaseContainsMatcher({
                manufacturer: e
            });
        }, V.midi.findPorts.nameMatcher = function(e) {
            return V.midi.findPorts.lowerCaseContainsMatcher({
                name: e
            });
        }, V.midi.findPorts.eachPortOfType = function(e, t, n) {
            var r = m.makeArray(e);
            m.each(r, function(e) {
                e.type === t && n(e);
            });
        }, V.midi.connection.openPort = function(e, t) {
            if (e.open) {
                var n = e.open();
                t.push(n);
            }
            return t;
        }, V.midi.connection.listen = function(e, t, n) {
            return V.midi.findPorts.eachPortOfType(e, "input", function(e) {
                V.midi.connection.openPort(e, n), e.addEventListener("midimessage", t, !1);
            }), n;
        }, V.midi.connection.stopListening = function(e, t) {
            V.midi.findPorts.eachPortOfType(e, "input", function(e) {
                e.close(), e.removeEventListener("midimessage", t, !1);
            });
        }, V.midi.connection.bindSender = function(e, t, n) {
            var r = m.makeArray(e);
            return m.each(r, function(e) {
                V.midi.connection.openPort(e, n), t.addListener(e.send.bind(e));
            }), n;
        }, V.midi.connection.fireReady = function(e, t) {
            !e || e.length < 1 || Promise.all(e).then(t);
        }, V.midi.connection.bind = function(e, t, n, r, a) {
            t = V.midi.connection.expandPortSpec(t);
            var o = V.midi.findPorts(e.inputs, t.input), i = V.midi.findPorts(e.outputs, t.output), u = [];
            o && 0 < o.length ? V.midi.connection.listen(o, r, u) : void 0 !== t.input && V.midi.connection.logNoMatchedPorts("input", t), 
            i && 0 < i.length ? V.midi.connection.bindSender(i, a, u) : void 0 !== t.output && V.midi.connection.logNoMatchedPorts("output", t), 
            V.midi.connection.fireReady(u, n);
        }, V.midi.connection.close = function(e, t) {
            V.midi.connection.stopListening(e.inputs, t);
        }, V.midi.connection.logNoMatchedPorts = function(e, t) {
            m.log(m.logLevel.WARN, "No matching " + e + " ports were found for port specification: ", t[e]);
        }, V.midi.connection.expandPortSpec = function(e) {
            if (void 0 !== e.input || void 0 !== e.output) return e;
            var t = {
                input: {},
                output: {}
            };
            return "number" == typeof e ? t.input = t.output = e : (V.midi.connection.expandPortSpecProperty("manufacturer", e, t), 
            V.midi.connection.expandPortSpecProperty("name", e, t)), t;
        }, V.midi.connection.expandPortSpecProperty = function(e, t, n) {
            return n.input[e] = n.output[e] = t[e], n;
        }, V.midi.connection.fireEvent = function(e, t) {
            var n = V.midi.read(e.data), r = n.type ? t[n.type] : void 0;
    ...
    !function() {
        ...
        }), V.midi.controller.optimizeMIDIMap = function(e) {
            var r = new Array(127);
            return m.each(e, function(e, t) {
                var n = Number(t);
                r[n] = m.makeArray(e);
            }), r;
        }, V.midi.controller.optimizeNoteMap = function(e) {
            return {
        ...
        }, V.midi.controller.expandControlMapSpec = function(e, t) {
            return t.transform.id = e, t.valuePath = t.valuePath || "value", t.transform.ugen || (t.transform.ugen = "flock.ugen.value"), 
            t;
        }, V.midi.controller.makeValueSynth = function(e, t, n) {
            var r = (n = V.midi.controller.expandControlMapSpec(t, n)).transform, a = n.valuePath;
            V.set(r, a, e);
            var o = V.synth.value({
                synthDef: r
            });
            return n.valuePath = t + "." + a, o;
        }, V.midi.controller.transformValue = function(e, t) {
            var n = t.transform;
            return "function" === typeof n ? n(e) : (t.transformSynth ? t.transformSynth.set(t.valuePath, e) : t.transformSynth = V.midi.controller.makeValueSynth(e, "flock-midi-controller-in", t), 
            t.transformSynth.value());
        }, V.midi.controller.setMappedValue = function(e, t, n) {
            e = void 0 !== t.value ? t.value : t.transform ? V.midi.controller.transformValue(e, t) : e, 
            (n[t.synth] || n).set(t.input, e);
        }, V.midi.controller.mapMIDIValue = function(e, t, n) {
            if (t && !(t.length < 1)) for (var r = 0; r < t.length; r++) {
                var a = t[r];
                V.midi.controller.setMappedValue(e, a, n);
            }
        }, V.midi.controller.mapControl = function(e, t, n) {
            var r = n[e.number], a = e.value;
            V.midi.controller.mapMIDIValue(a, r, t);
        }, V.midi.controller.mapNote = function(e, t, n, r) {
            var a = r[e], o = t.note, i = r.velocity, u = t.velocity;
            V.midi.controller.mapMIDIValue(o, a, n), V.midi.controller.mapMIDIValue(u, i, n);
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        m.defaults("flock.webAudio.nativeNodeManager", {
        ...
        }), V.webAudio.nativeNodeManager.createInputNode = function(e, t, n) {
            var r = e.createNode(t);
            return e.insertInput(r, n);
        }, V.webAudio.nativeNodeManager.createOutputNode = function(e, t) {
            var n = e.createNode(t);
            return e.insertOutput(n);
        }, V.webAudio.nativeNodeManager.connectOutput = function(e, t) {
            e !== t && e.connect(t);
        }, V.webAudio.nativeNodeManager.disconnectOutput = function(e) {
            e.outputNode && e.outputNode.disconnect(0);
        }, V.webAudio.nativeNodeManager.removeAllInputs = function(e) {
            for (var t = 0; t < e.length; t++) {
                e[t].disconnect(0);
            }
            e.length = 0;
        }, V.webAudio.nativeNodeManager.insertInput = function(e, t, n, r, a) {
            ...
            V.fail("There are too many input nodes connected to Flocking. The maximum number of input buses is currently set to " + o + ". Either remove an existing input node or increase Flockings numInputBuses option.");
        }, V.webAudio.nativeNodeManager.removeInput = function(e, t) {
            var n = t.indexOf(e);
            -1 < n && t.splice(n, 1), e.disconnect(0);
        }, V.webAudio.nativeNodeManager.insertOutput = function(e, t) {
            return V.webAudio.nativeNodeManager.disconnectOutput(e), e.outputNode = t;
        }, V.webAudio.nativeNodeManager.removeOutput = function(e) {
            V.webAudio.nativeNodeManager.insertOutput(e);
        };
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    !function() {
        ...
        m.defaults("flock.webAudio.outputManager", {
            ...
            model: {
                isGenerating: !1,
                shouldInitIOS: V.platform.isIOS,
                audioSettings: {}
            },
            invokers: {
                bindAudioProcess: {
        ...
        }), V.webAudio.outputManager.bindAudioProcess = function(e, t, n, r) {
            var a = n.scriptProcessor.node;
            a.model = r, a.nodeList = e, a.buses = t, a.inputNodes = n.inputNodes, a.onaudioprocess = V.webAudio.outputManager.writeSamples;
        }, V.webAudio.outputManager.unbindAudioProcess = function(e) {
            e.scriptProcessor.node.onaudioprocess = void 0;
        }, V.webAudio.outputManager.writeSamples = function(e) {
            ...
            if (o.length < 1) for (t = 0; t < p; t++) V.clearBuffer(s.getChannelData(t)); else for (n = 0; n < l; n++) {
                var g = n * f;
                if (V.evaluate.clearBuses(c, d, f), 0 < a) for (t = 0; t < m; t++) {
                    var h = u.getChannelData(t), v = c[p + t];
                    for (r = 0; r < f; r++) v[r] = h[r + g];
                }
                for (V.evaluate.synths(o), t = 0; t < p; t++) {
                    var y = c[t], b = s.getChannelData(t);
                    for (r = 0; r < f; r++) b[r + g] = y[r];
                }
            }
        }, V.webAudio.outputManager.iOSStart = function(e, t, n) {
    ...
    !function() {
        "use strict";
        var o = m.registerNamespace("jQuery");
        V.ugenDefaults = function(e, t) {
            return 1 === arguments.length ? V.ugenDefaults.store[e] : V.ugenDefaults.store[e] = t;
        }, V.ugenDefaults.store = {}, V.isUGen = function(e) {
            return e && e.tags && -1 < e.tags.indexOf("flock.ugen");
        }, V.aliasUGen = function(e, t, n, r) {
            var a = V.get(e);
            V.set(a, t, function(e, t, n) {
                return n = o.extend(!0, {}, r, n), a(e, t, n);
            }), V.ugenDefaults(e + "." + t, n);
        }, V.aliasUGens = function(e, t) {
            var n, r;
            for (n in t) r = t[n], V.aliasUGen(e, n, {
                inputs: r.inputDefaults
            }, r.options);
        }, V.copyUGenDefinition = function(e, t) {
            var n = V.ugenDefaults(e), r = m.getGlobalValue(e);
            m.setGlobalValue(t, r), V.ugenDefaults(t, m.copy(n));
        }, V.krMul = function(e, t, n) {
            var r, a = n.output[0];
            for (r = 0; r < e; r++) t[r] = t[r] * a;
        }, V.mul = function(e, t, n) {
            var r, a = n.output;
            for (r = 0; r < e; r++) t[r] = t[r] * a[r];
        }, V.krAdd = function(e, t, n, r) {
            var a, o = r.output[0];
            for (a = 0; a < e; a++) t[a] = t[a] + o;
        }, V.add = function(e, t, n, r) {
            var a, o = r.output;
            for (a = 0; a < e; a++) t[a] = t[a] + o[a];
        }, V.krMulAdd = function(e, t, n, r) {
            var a, o = n.output[0], i = r.output;
            for (a = 0; a < e; a++) t[a] = t[a] * o + i[a];
        }, V.mulKrAdd = function(e, t, n, r) {
            var a, o = n.output, i = r.output[0];
            for (a = 0; a < e; a++) t[a] = t[a] * o[a] + i;
        }, V.krMulKrAdd = function(e, t, n, r) {
            var a, o = n.output[0], i = r.output[0];
            for (a = 0; a < e; a++) t[a] = t[a] * o + i;
        }, V.mulAdd = function(e, t, n, r) {
            var a, o = n.output, i = r.output;
            for (a = 0; a < e; a++) t[a] = t[a] * o[a] + i[a];
        }, V.onMulAddInputChanged = function(t) {
            var e, n = t.inputs.mul, r = t.inputs.add;
            t.mulAdd = n || r ? (e = n ? r ? n.rate !== V.rates.AUDIO ? r.rate !== V.rates.AUDIO ? V.krMulKrAdd : V.krMulAdd : r.rate !== V.rates.AUDIO ? V.mulKrAdd : V.mulAdd : n.rate !== V.rates.AUDIO ? V.krMul : V.mul : r.rate !== V.rates.AUDIO ? V.krAdd : V.add, 
            t.mulAddFn = e, function(e) {
                t.mulAddFn(e, t.output, t.inputs.mul, t.inputs.add);
            }) : t.mulAddFn = V.noOp;
        }, V.ugen = function(e, t, n) {
            var u = {
                enviro: (n = n || {}).enviro || V.environment,
                rate: n.rate || V.rates.AUDIO,
                inputs: e,
                output: t,
                options: n,
                model: n.model || {
            ...
            return u.lastOutputIdx = u.output.length - 1, u.get = function(e) {
                return V.input.get(u.inputs, e);
            }, u.set = function(e, t) {
                return V.input.set(u.inputs, e, t, u, function(e) {
                    if (null != e) return V.parse.ugenDef(e, u.enviro, {
                ...
                return e ? "string" == typeof e ? arguments.length < 2 ? u.get(e) : u.set(e, t) : V.isIterable(e) ? u.get(e) : u.set(e, t) : void 0;
            }, u.calculateStrides = function() {
                var e, t, n, r = u.model, a = u.options.strideInputs, o = u.inputs;
                if (r.strides = r.strides || {}, a) for (e = 0; e < a.length; e++) (n = o[t = a[e]]) ? r.strides[t] = n.rate === V.rates.AUDIO ? 1 : 0 : m.log(m.logLevel.WARN, "An invalid input ('" + t + "') was found on a unit generator: " + u);
                ...
                r = u.inputs[t], V.ugen.collectMultiInputs(r, n);
            }, u.onInputChanged = function(e) {
                var t = u.options.multiInputNames;
                V.onMulAddInputChanged(u), u.options.strideInputs && u.calculateStrides(), !t || e && !t.indexOf(e) || u.collectMultiInputs();
            }, u.init = function() {
                ...
                a.nyquistRate = a.sampleRate, a.blockSize = u.rate === V.rates.AUDIO ? t.blockSize : 1, 
                a.sampleDur = 1 / a.sampleRate, u.interpolate = V.interpolate.none, o.interpolation) {
                    var i = V.interpolate[o.interpolation];
                ...
                u.rate === V.rates.DEMAND && u.inputs.freq && (n = V.parse.ugenDefForConstantValue(1), 
                u.inputs.freq = V.parse.ugenDef(n, u.enviro));
            }, u.init(), u;
        }, V.ugen.collectMultiInputs = function(e, t) {
            V.isIterable(e) || (e = e = m.makeArray(e));
            for (var n = 0; n < e.length; n++) {
                var r = e[n];
                V.ugen.collectChannelsForInput(r, t);
            }
            return t;
        }, V.ugen.collectChannelsForInput = function(e, t) {
            var n, r = V.hasTag(e, "flock.ugen.multiChannelOutput") ? e.output : [ e.output ];
            for (n = 0; n < r.length; n++) t.push({
                rate: e.rate,
                output: r[n]
            });
            return t;
        }, V.ugen.lastOutputValue = function(e, t) {
            return t[e - 1];
        }, V.ugen.buffer = function(r) {
            r.onBufferInputChanged = function(e) {
                var t = r.model, n = r.inputs;
                t.bufDef === n.buffer && "buffer" !== e || (t.bufDef = n.buffer, V.parse.bufferForDef(t.bufDef, r, r.enviro));
            }, r.setBuffer = function(e) {
                r.buffer = e, r.onBufferReady && r.onBufferReady(e);
            }, r.initBuffer = function() {
                r.buffer = r.model.bufDef = V.bufferDesc({
                    format: {
            ...
            return a.value = function() {
                ...
                a.mulAdd(e), n.value = V.ugen.lastOutputValue(e, t);
            }, a.onInputChanged = function() {
                var e = a.inputs;
                a.model.unscaledValue = e.value, "constant" !== a.rate ? a.gen = a.dynamicGen : a.gen = void 0, 
                V.onMulAddInputChanged(a), a.dynamicGen(1);
            }, a.onInputChanged(), a;
        }, V.ugenDefaults("flock.ugen.value", {
            rate: "control",
            inputs: {
                value: 1,
                mul: null,
        ...
        }), V.ugen.silence = function(e, t, n) {
            var r = V.ugen(e, t, n);
            return r.onInputChanged = function() {
                for (var e = 0; e < r.output.length; e++) r.output[e] = 0;
            }, r.onInputChanged(), r;
        }, V.ugenDefaults("flock.ugen.silence", {
            rate: "constant"
        }), V.ugen.passThrough = function(e, t, n) {
            var i = V.ugen(e, t, n);
            return i.gen = function(e) {
                var t, n, r = i.model, a = i.inputs.source.output, o = i.output;
                for (t = 0; t < a.length; t++) o[t] = n = a[t];
                for (;t < e; t++) o[t] = n = 0;
                r.unscaledValue = n, i.mulAdd(e), r.value = V.ugen.lastOutputValue(e, o);
            }, i.onInputChanged(), i;
        }, V.ugenDefaults("flock.ugen.passThrough", {
            rate: "audio",
            inputs: {
                source: null,
                mul: null,
            ...
            return h.gen = function(e) {
                ...
                if (t = f.length, n = Math.max(g, t), !(t < 1)) {
                    for (r = 0; r < n; r++) {
                        for (i = (o = f[r % t]).rate, u = p[m + r], s = i === V.rates.AUDIO ? 1 : 0, a = l = 0; a < e; a++, 
        ...
        }), V.ugen.valueOut = function(e, t, n) {
            var r = V.ugen(e, t, n);
            return r.arraySourceGen = function() {
                ...
                V.isIterable(t) ? (r.gen = r.arraySourceGen, e.value = new Float32Array(t.length), 
                e.unscaledValue = e.value) : r.gen = r.ugenSourceGen;
            }, r.onInputChanged(), r;
        }, V.ugenDefaults("flock.ugen.valueOut", {
            rate: "control",
            inputs: {
                sources: null
            },
        ...
        }), V.ugen.in = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.singleBusGen = function(e) {
                var t = s.model, n = s.output;
                V.ugen.in.readBus(e, n, s.inputs.bus, s.options.buses), t.unscaledValue = V.ugen.lastOutputValue(e, n), 
                s.mulAdd(e), t.value = V.ugen.lastOutputValue(e, n);
                ...
                a.unscaledValue = r, s.mulAdd(e), a.value = V.ugen.lastOutputValue(e, u);
            }, s.onInputChanged = function() {
                s.gen = V.isIterable(s.inputs.bus) ? s.multiBusGen : s.singleBusGen, V.onMulAddInputChanged(s);
            }, s.onInputChanged(), s;
        }, V.ugen.in.readBus = function(e, t, n, r) {
            var a, o = r[0 | n.output[0]];
            for (a = 0; a < e; a++) t[a] = o[a];
        }, V.ugenDefaults("flock.ugen.in", {
            rate: "audio",
            inputs: {
                bus: 0,
                mul: null,
    ...
    !function() {
        ...
        V.blit = function(e) {
        ...
        }, V.blit.period = function(e, t) {
            var n = e / t;
            return n < 1 ? 1 : n;
        }, V.blit.updatePeriodState = function(e, t) {
            e.freq = t < 1e-6 ? 1e-6 : t, e.d0 = V.blit.period(e.sampleRate, e.freq);
        }, V.ugen.blit = function(e, t, n) {
            var u = V.ugen(e, t, n);
            return u.gen = function(e) {
                var t, n, r = u.model, a = u.output, o = u.inputs.freq.output[0], i = r.phase;
                for (t = 0; t < e; t++) (i -= 1) < -2 && (V.blit.updatePeriodState(r, o), i += r.d0), 
                n = V.blit(i), a[t] = n;
                r.phase = i, r.unscaledValue = n, u.mulAdd(e), r.value = V.ugen.lastOutputValue(e, a);
            }, u.init = function() {
                u.onInputChanged();
            }, u.init(), u;
        }, V.ugenDefaults("flock.ugen.blit", {
            rate: "audio",
            inputs: {
                freq: 440,
                mul: null,
            ...
            return s.gen = function(e) {
                ...
                for (void 0 === i && (V.ugen.saw.updatePeriodState(n, a), i = n.d0 / 2), t = 0; t < e; t++) (i -= 1) < -2 && (V.ugen.saw.updatePeriodState(n, a), 
                i += n.d0), r[t] = u = V.blit(i) - n.dcOffset + o * u;
                n.phase = i, n.unscaledValue = u, s.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, s.init = function() {
                s.onInputChanged();
            }, s.init(), s;
        }, V.ugen.saw.updatePeriodState = function(e, t) {
            V.blit.updatePeriodState(e, t), e.dcOffset = 1 / e.d0;
        }, V.ugenDefaults("flock.ugen.saw", {
            rate: "audio",
            inputs: {
                freq: 440,
                leakRate: .01,
        ...
        }), V.ugen.square = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.gen = function(e) {
                var t, n = s.model, r = s.output, a = s.inputs.freq.output[0], o = 1 - s.inputs.leakRate.output[0], i = n.phase, u = n.unscaledValue;
                for (void 0 === i && (V.ugen.square.updatePeriodState(n, a), i = n.phaseResetValue), 
                t = 0; t < e; t++) r[t] = u = V.blit(i) * n.sign + o * u, i < -2 && (V.ugen.square.updatePeriodState(n, a), 
                i += n.phaseResetValue), i -= 1;
                n.phase = i, n.unscaledValue = u, s.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, s.init = function() {
                s.onInputChanged();
            }, s.init(), s;
        }, V.ugen.square.updatePeriodState = function(e, t) {
            V.blit.updatePeriodState(e, t), e.phaseResetValue = e.d0 / 2, e.sign *= -1;
        }, V.ugenDefaults("flock.ugen.square", {
            rate: "audio",
            inputs: {
                freq: 440,
                leakRate: .01,
            ...
            return c.gen = function(e) {
                ...
                for (void 0 === u && (V.ugen.tri.updatePeriodState(r, o), u = r.d0 / 4), t = 0; t < e; t++) l = n = (s = V.blit(u) * r.sign + i * s) + i * l, 
                a[t] = n * r.ampScale, (u -= 1) < -2 && (V.ugen.tri.updatePeriodState(r, o), u += r.phaseResetValue);
                r.phase = u, r.unscaledValue = s, r.secondPrevVal = l, c.mulAdd(e), r.value = V.ugen.lastOutputValue(e, a);
            }, c.init = function() {
                c.onInputChanged();
            }, c.init(), c;
        }, V.ugen.tri.updatePeriodState = function(e, t) {
            V.blit.updatePeriodState(e, t), e.phaseResetValue = e.d0 / 2, e.ampScale = 2 / e.d0, 
            e.sign *= -1;
        }, V.ugenDefaults("flock.ugen.tri", {
            rate: "audio",
            inputs: {
                freq: 440,
                leakRate: .01,
    ...
    !function() {
        "use strict";
        V.ugen.playBuffer = function(y, e, t) {
            var b = V.ugen(y, e, t);
            return b.defaultKrTriggerGen = function(e) {
                ...
                r.idx = u, r.unscaledValue = n, b.mulAdd(e), r.value = V.ugen.lastOutputValue(e, a);
                ...
                for (r = n = t = 0; t < e; t++, n += s.strides.trigger, r += s.strides.speed) {
                    if (a = p[n], o = s.prevTrig, i = d[r], 0 < (s.prevTrig = a) && o <= 0) m = V.ugen.playBuffer.resetIndex(i, h, v); else if (m < h || v < m) {
                        if (!(0 < g && 0 < a)) {
                            l[t] = u = 0;
                            continue;
                        }
                        m = V.ugen.playBuffer.resetIndex(i, h, v);
                    }
                    u = b.interpolate(m, f), l[t] = u, m += s.stepSize * i;
                }
                s.idx = m, s.unscaledValue = u, b.mulAdd(e), s.value = V.ugen.lastOutputValue(e, l);
            }, b.onInputChanged = function(e) {
                var t = b.inputs, n = t.speed, r = t.start, a = t.end, o = t.trigger;
                b.onBufferInputChanged(e), b.gen = n.rate === V.rates.CONSTANT && 1 === n.output[0] && r.rate === V.rates.CONSTANT && 0 === r.output[0] && a.rate === V.rates.CONSTANT && 1 === a.output[0] && o.rate !== V.rates.AUDIO ? b.defaultKrTriggerGen : b.otherwiseGen, 
                b.calculateStrides(), V.onMulAddInputChanged(b);
                ...
                V.ugen.buffer(b), b.initBuffer(), b.onInputChanged();
            }, b.init(), b;
        }, V.ugen.playBuffer.resetIndex = function(e, t, n) {
            return 0 < e ? t : n;
        }, V.ugenDefaults("flock.ugen.playBuffer", {
            rate: "audio",
            inputs: {
                channel: 0,
                loop: 0,
        ...
        }), V.ugen.readBuffer = function(e, t, n) {
            var f = V.ugen(e, t, n);
            return f.gen = function(e) {
                ...
                o.unscaledValue = a, f.mulAdd(e), o.value = V.ugen.lastOutputValue(e, u);
            }, f.onInputChanged = function(e) {
                f.onBufferInputChanged(e), f.calculateStrides(), V.onMulAddInputChanged(f);
            }, f.init = function() {
                V.ugen.buffer(f), f.initBuffer(), f.onInputChanged();
            }, f.init(), f;
        }, V.ugenDefaults("flock.ugen.readBuffer", {
            rate: "audio",
            inputs: {
                buffer: null,
                channel: 0,
        ...
        }), V.ugen.writeBuffer = function(e, t, n) {
            var y = V.ugen(e, t, n);
            return y.gen = function(e) {
                ...
                var l = V.bufferDesc(s, a.rates.audio, i);
                ...
                y.setupBuffer(y.inputs.buffer)), V.onMulAddInputChanged(y);
            }, y.init = function() {
                y.onInputChanged();
            }, y.init(), y;
        }, V.ugenDefaults("flock.ugen.writeBuffer", {
            rate: "audio",
            inputs: {
                sources: null,
                buffer: null,
        ...
        }), V.ugen.bufferDuration = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.krGen = function(e) {
                ...
                for (t = 0; t < e; t++) r[t] = u;
                n.unscaledValue = u, s.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, s.onInputChanged = function(e) {
                V.onMulAddInputChanged(s), s.onBufferInputChanged(e);
            }, s.onBufferReady = function() {
                s.krGen(1);
            }, s.init = function() {
                var e = s.rate;
                s.gen = e === V.rates.CONTROL || e === V.rates.AUDIO ? s.krGen : void 0, s.output[0] = 0, 
                V.ugen.buffer(s), s.initBuffer(), s.onInputChanged();
            }, s.init(), s;
        }, V.ugenDefaults("flock.ugen.bufferDuration", {
            rate: "constant",
            inputs: {
                buffer: null,
                channel: 0
        ...
        }), V.ugen.bufferLength = function(e, t, n) {
            var i = V.ugen(e, t, n);
            return i.krGen = function(e) {
                var t, n = i.model, r = i.output, a = i.inputs.channel.output[0], o = i.buffer.data.channels[a].length;
                for (t = 0; t < e; t++) r[t] = o;
                n.unscaledValue = o, i.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, i.onInputChanged = function(e) {
                V.onMulAddInputChanged(i), i.onBufferInputChanged(e);
            }, i.onBufferReady = function() {
                i.krGen(1);
            }, i.init = function() {
                var e = i.rate;
                i.gen = e === V.rates.CONTROL || e === V.rates.AUDIO ? i.krGen : void 0, i.output[0] = 0, 
                V.ugen.buffer(i), i.initBuffer(), i.onInputChanged();
            }, i.init(), i;
        }, V.ugenDefaults("flock.ugen.bufferLength", {
            rate: "constant",
            inputs: {
                buffer: null,
                channel: 0
        ...
        }), V.ugen.bufferPhaseStep = function(e, t, n) {
            var i = V.ugen(e, t, n);
            return i.krGen = function(e) {
                var t, n = i.model, r = i.output, a = n.unscaledValue;
                for (t = 0; t < e; t++) r[t] = a;
                i.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, i.onInputChanged = function(e) {
                i.onBufferInputChanged(e), V.onMulAddInputChanged(i);
        ...
        }, V.ugenDefaults("flock.ugen.bufferPhaseStep", {
            rate: "constant",
            inputs: {
                buffer: null,
                channel: 0
        ...
        }), V.ugen.sampleRate = function(e, t, n) {
            var r = V.ugen(e, t, n), a = r.model;
            return r.output[0] = a.value = a.unscaledValue = r.options.audioSettings.rates.audio, 
            r;
        }, V.ugenDefaults("flock.ugen.sampleRate", {
            rate: "constant",
            inputs: {}
        }), V.ugen.triggerBuffers = function(e, t, n) {
            var T = V.ugen(e, t, n);
            return T.gen = function(e) {
                var t, n, r, a, o, i, u, s, l, c, d = T.model, f = d.strides, p = T.output, m = T.inputs, g = T.buffers, h = g.length - 1, v = d.prevTrigger, y = d.maxVoices, b = d.activeVoices, k = d.freeVoices, S = m.trigger.output, x = f.trigger, C = 0, A = m.bufferIndex.output, w = f.bufferIndex, I = 0, N = m.speed.output, M = f.speed, P = 0, O = T.inputs.channel.output[0];
                for (t = 0; t < e; t++) {
                    if (0 < (n = S[C]) && v <= 0 && b.length < y) {
                ...
                d.prevTrigger = v, d.unscaledValue = c, T.mulAdd(e), d.value = V.ugen.lastOutputValue(e, p);
            }, T.init = function() {
                ...
                V.onMulAddInputChanged(T), T.calculateStrides();
            }, T.init(), T;
        }, V.ugenDefaults("flock.ugen.triggerBuffers", {
            inputs: {
                trigger: 0,
                bufferIndex: 0,
                speed: 1,
        ...
        }), V.ugen.chopBuffer = function(e, t, n) {
            var r = V.ugen(e, t, n);
            return V.ugen.buffer(r), r.gen = function(e) {
                var t = r.model, n = r.output;
                V.ugen.chopBuffer.prepareVoices(r, e), V.ugen.chopBuffer.generateSamplesForAllVoices(r, e), 
                t.unscaledValue = V.ugen.lastOutputValue(e, n), r.mulAdd(e), t.value = V.ugen.lastOutputValue(e, n);
            }, r.onInputChanged = function(e) {
                r.onBufferInputChanged(e), r.calculateStrides(), V.onMulAddInputChanged(r);
            }, r.onBufferReady = function() {
                var e = r.model;
                e.stepSize = r.buffer.format.sampleRate / e.sampleRate, e.lastIdx = r.buffer.format.numSampleFrames - 1;
            }, r.init = function() {
                V.ugen.chopBuffer.initVoices(r), r.initBuffer(), r.onInputChanged();
                var e = r.buffer.data.channels[r.inputs.channel.output[0]];
                r.model.lastIdx = e.length - 1;
            }, r.init(), r;
        }, V.ugen.chopBuffer.initVoice = function() {
            return {
                currentStage: 4,
                samplesRemaining: 0,
                duration: 0,
        ...
        }, V.ugen.chopBuffer.initVoices = function(e) {
            for (var t = e.model, n = 0; n < e.options.maxVoices; n++) {
                var r = V.ugen.chopBuffer.initVoice(e);
                t.freeVoices[n] = r;
            }
        }, V.ugen.chopBuffer.randomIndex = V.randomValue, V.ugen.chopBuffer.randomStartIndex = function(e) {
            var t = e.model, n = e.inputs, r = n.end.output[0] - t.inputState.numDurationSamps;
            return r = Math.max(0, r), V.ugen.chopBuffer.randomIndex(n.start.output[0], r) * t.lastIdx;
        }, V.ugen.chopBuffer.allocateVoice = function(e) {
            ...
            if (!(t.freeVoices.length < 1)) {
                ...
                return r.hasTriggeredNextVoice = !1, r.currentStage = V.ugen.chopBuffer.stages.WAIT, 
                r.samplesRemaining = t.inputState.numDurationSamps + t.inputState.numGapSamps, r.idx = V.ugen.chopBuffer.randomStartIndex(e), 
                r;
            }
        }, V.ugen.chopBuffer.updateVoiceState = function(e, t) {
        ...
        }, V.ugen.chopBuffer.triggerNextVoice = function(e, t, n, r, a) {
            var o = t.samplesRemaining + a;
            o < n && (e.model.stageSampleState[0] = o, V.ugen.chopBuffer.allocateVoice(e), t.hasTriggeredNextVoice = !0);
        }, V.ugen.chopBuffer.envLength = function(e, t, n) {
            return Math.floor((t < e ? t : e) * n);
        }, V.ugen.chopBuffer.deactivateVoice = function(e, t) {
            var n = e.model, r = n.activeVoices.indexOf(t);
            -1 < r && n.activeVoices.splice(r, 1), n.freeVoices.push(t);
        }, V.ugen.chopBuffer.prepareVoice = function(e, t, n) {
            V.ugen.chopBuffer.updateVoiceState(e, t), t.currentStage < V.ugen.chopBuffer.stages.DONE ? t.hasTriggeredNextVoice || V.ugen.chopBuffer.triggerNextVoice(e, t, n) : V.ugen.chopBuffer.deactivateVoice(e, t);
        }, V.ugen.chopBuffer.durationSamples = function(e, t, n) {
            return 0 === t ? n.lastIdx : Math.floor(e / t * n.sampleRate);
        }, V.ugen.chopBuffer.updateInputState = function(e, t) {
            var n = t.inputState, r = e.amount.output[0], a = e.minDuration.output[0], o = a / 2;
            return n.numDurationSamps = V.ugen.chopBuffer.durationSamples(a, r, t), n.numAttackSamps = V.ugen.chopBuffer.envLength(e.attack.output[0], o, t.sampleRate), 
            n.numReleaseSamps = V.ugen.chopBuffer.envLength(e.release.output[0], o, t.sampleRate), 
            ...
            n;
        }, V.ugen.chopBuffer.prepareVoices = function(e, t) {
            var n = e.model;
            V.ugen.chopBuffer.updateInputState(e.inputs, n), n.stageSampleState[0] = n.inputState.numGapSamps, 
            ...
            for (var r = 0; r < n.activeVoices.length; r++) {
                ...
                V.ugen.chopBuffer.prepareVoice(e, a, t);
            }
            0 === n.activeVoices.length && V.ugen.chopBuffer.allocateVoice(e);
        }, V.ugen.chopBuffer.generateSamplesForVoice = function(e, t, n) {
            for (var r = e.model, a = e.output, o = e.inputs, i = o.speed.output, u = e.buffer.data.channels[o.channel.output[0]], s = 0, l = 0; s < Math.min(n, t.samplesRemaining) && !(t.currentStage >= V.ugen.chopBuffer.stages.DONE); s++, 
            l += r.strides.speed) {
            ...
            t.samplesRemaining <= 0 && t.currentStage < V.ugen.chopBuffer.stages.DONE && (t.currentStage = V.ugen.chopBuffer.stages.DONE);
        }, V.ugen.chopBuffer.generateSamplesForAllVoices = function(e, t) {
            var n = e.model;
            V.clearBuffer(e.output);
            for (var r = n.activeVoices.length - 1; 0 <= r; r--) {
                var a = n.activeVoices[r];
                V.ugen.chopBuffer.generateSamplesForVoice(e, a, t);
            }
        }, V.ugen.chopBuffer.stages = {
            WAIT: 0,
            ATTACK: 1,
            SUSTAIN: 2,
            RELEASE: 3,
            DONE: 4
        }, V.ugenDefaults("flock.ugen.chopBuffer", {
            rate: "audio",
            inputs: {
                buffer: null,
                channel: 0,
    ...
    !function() {
        ...
        }, V.ugenDefaults("flock.ugen.print", {
            rate: "audio",
            inputs: {
                source: null,
                trigger: 0,
    ...
    !function() {
        "use strict";
        V.ugen.distortion = function(e, t, n) {
            var f = V.ugen(e, t, n);
            return f.gen = function(e) {
                ...
                u[r] = n;
                i.unscaledValue = n, f.mulAdd(e), i.value = V.ugen.lastOutputValue(e, u);
            }, f.onInputChanged(), f;
        }, V.ugenDefaults("flock.ugen.distortion", {
            rate: "audio",
            inputs: {
                source: null,
                gain: 1
        ...
        }), V.ugen.distortion.tanh = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.gen = function(e) {
                var t, n, r, a = s.model, o = s.output, i = s.inputs.source.output, u = a.strides.source;
                for (n = r = 0; n < e; n++, r += u) t = Math.tanh(i[r]), o[n] = t;
                a.unscaledValue = t, s.mulAdd(e), a.value = V.ugen.lastOutputValue(e, o);
            }, s.onInputChanged(), s;
        }, V.ugenDefaults("flock.ugen.distortion.tanh", {
            rate: "audio",
            inputs: {
                source: null
            },
        ...
        }), V.ugen.distortion.deJong = function(e, t, n) {
            var m = V.ugen(e, t, n);
            return m.gen = function(e) {
                ...
                l[o] = a;
                s.unscaledValue = a, m.mulAdd(e), s.value = V.ugen.lastOutputValue(e, l);
            }, m.onInputChanged(), m;
        }, V.ugenDefaults("flock.ugen.distortion.deJong", {
            rate: "audio",
            inputs: {
                source: null,
                amount: 2
        ...
        }), V.copyUGenDefinition("flock.ugen.distortion.deJong", "flock.ugen.distortion.deJonge"), 
        V.ugen.distortion.tarrabiaDeJong = function(e, t, n) {
            var m = V.ugen(e, t, n);
            return m.gen = function(e) {
                var t, n, r, a, o, i, u, s = m.model, l = m.output, c = m.inputs.source.output, d = s.strides.source, f = m.inputs.amount.output, p = s.strides.amount;
                for (a = o = i = 0; a < e; a++, o += d, i += p) t = c[o], 1 <= (n = f[i]) ? n = .9999999999999999 : n < -1 && (n = -1), 
                r = (1 + (u = 2 * n / (1 - n))) * t / (1 + u * Math.abs(t)), l[a] = r;
                s.unscaledValue = r, m.mulAdd(e), s.value = V.ugen.lastOutputValue(e, l);
            }, m.onInputChanged(), m;
        }, V.ugenDefaults("flock.ugen.distortion.tarrabiaDeJong", {
            rate: "audio",
            inputs: {
                source: null,
                amount: 1
        ...
        }), V.copyUGenDefinition("flock.ugen.distortion.tarrabiaDeJong", "flock.ugen.distortion.tarrabiaDeJonge"), 
        V.ugen.distortion.gloubiBoulga = function(e, t, n) {
            var m = V.ugen(e, t, n);
            return m.gen = function(e) {
                ...
                s.unscaledValue = t, m.mulAdd(e), s.value = V.ugen.lastOutputValue(e, l);
            }, m.onInputChanged(), m;
        }, V.ugenDefaults("flock.ugen.distortion.gloubiBoulga", {
            rate: "audio",
            inputs: {
                source: null,
                gain: 1
    ...
    !function() {
        "use strict";
        V.ugen.normalize = function(e, t, n) {
            var a = V.ugen(e, t, n);
            return a.gen = function() {
                var e = a.model, t = a.output, n = a.inputs.max.output[0], r = a.inputs.source.output;
                V.normalize(r, n, t), e.value = e.unscaledValue = t[t.length - 1];
            }, a.onInputChanged(), a;
        }, V.ugenDefaults("flock.ugen.normalize", {
            rate: "audio",
            inputs: {
                max: 1,
                source: null
    ...
    !function() {
        "use strict";
        var o = m.registerNamespace("jQuery"), n = V.requireModule("webarraymath", "ArrayMath");
        V.envelope = {}, V.envelope.makeCreator = function(r, a) {
            return function(e) {
                var t = V.ugenDefaults(r), n = o.extend(!0, {}, t, e);
                return a(n);
            };
        }, V.envelope.registerCreators = function(e, t) {
            var n, r;
            for (var a in t) n = m.pathUtil.composePath(e, a), r = t[a], V.ugenDefaults(n, r.defaults), 
            m.setGlobalValue(n, V.envelope.makeCreator(n, r.transformer));
        }, V.envelope.creatorSpecs = {
            line: {
        ...
        }, V.envelope.registerCreators("flock.envelope", V.envelope.creatorSpecs), V.envelope.validate = function(e, t) {
            var n = e.levels, r = {};
            if (e.times ? !n || n.length < 2 ? r.levels = "An array containing at least two levels must be specified." : (V.envelope.validate.times(e.times, n, r), 
            V.envelope.validate.levels(n, r), V.envelope.validate.curves(e.curve, n, r), V.envelope.validate.sustainPoint(e.sustainPoint, n, r)) : r.times = "An array containing at least one time value must be specified.", 
            !1 !== t) for (var a in r) V.fail(r[a]);
            return r;
        }, V.envelope.validate.times = function(e, t, n) {
        ...
        }, V.envelope.validate.levels = function(e, t) {
            for (var n = 0; n < e.length; n++) isNaN(e[n]) && (t.levels = "A NaN level value was specified at index " + n + ". levels: " + e);
        }, V.envelope.validate.curves = function(t, e, n) {
            if (!t) return n;
            V.isIterable(t) && (t.length !== e.length - 1 && (n.curve = "When curve is specified as an array, there should be one fewer curve value than the number of level values. curve: " + t + " levels: " + e), 
            m.each(t, function(e) {
                V.lineGenerator(e) || (n.curve = "'" + e + "' is not a valid curve type. curve: " + t);
            })), V.lineGenerator(t) || (n.curve = "'" + t + "' is not a valid curve type.");
        }, V.envelope.validate.sustainPoint = function(e, t, n) {
            (e < 0 || e >= t.length) && (n.sustainPoint = "The specified sustainPoint index is out range for the levels array. sustainPoint: " + e + " levels: " + t);
        }, V.envelope.expand = function(e) {
            var t = "string" == typeof e ? m.invokeGlobalFunction(e) : e.type ? m.invokeGlobalFunction(e.type, [ e ]) : e;
            if (t.curves && !t.curve && (t.curve = t.curves), !V.isIterable(t.curve)) {
                var n = t.levels.length - 1;
                t.curve = V.fillBufferWithValue(new Array(n), t.curve);
            }
            return V.envelope.validate(t, !0), t;
        }, V.fillBufferWithLine = function(e, t, n, r, a, o) {
            a = void 0 === a ? 0 : a;
            var i = (o = void 0 === o ? t.length : o) - a, u = V.fillBufferWithLine.singletonModel;
            u.unscaledValue = n, u.destination = r, u.numSegmentSamps = i - 1, "number" == typeof e && (u.currentCurve = e, 
            e = "curve");
            var s = V.line[e];
            return s || V.fail("No line generator could be found for type " + e), s.init(u), 
            s.gen(i, a, t, u);
        }, V.fillBufferWithLine.singletonModel = {
            unscaledValue: 0,
            value: 0,
            destination: 1
        }, V.lineGenerator = function(e) {
            var t = typeof e;
            return "string" === t ? V.line[e] : "number" === t ? V.line.curve : V.line.linear;
        }, V.line = {
            constant: {
                init: function(e) {
                    e.stepSize = 0;
            ...
            curve: {
                init: function(e) {
                    if (Math.abs(e.currentCurve) < .001) return V.line.linear.init(e);
            ...
            sin: {
                init: function(e) {
                    ...
                    e.y2 = e.y1 * Math.sin(V.HALFPI - t), e.unscaledValue = e.a2 - e.y1;
                },
                gen: function(e, t, n, r) {
            ...
            welsh: {
                init: function(e) {
                    var t = V.HALFPI / e.numSegmentSamps, n = Math.cos(t);
            ...
            return l.gen = function(e) {
                ...
                n.level = n.unscaledValue = u, n.numSteps = a, l.mulAdd(e), n.value = V.ugen.lastOutputValue(e, s);
                ...
                e.level = e.start), V.onMulAddInputChanged(l);
            }, l.onInputChanged(), l;
        }, V.ugenDefaults("flock.ugen.line", {
            rate: "control",
            inputs: {
                start: 0,
                end: 1,
            ...
            return l.gen = function(e) {
                ...
                var e = l.model;
                V.onMulAddInputChanged(l), e.start = l.inputs.start.output[0], 0 === e.start && (e.start = 1e-101), 
        ...
        }, V.ugenDefaults("flock.ugen.xLine", {
            rate: "control",
            inputs: {
                start: 0,
                end: 1,
            ...
            return m.gen = function(e) {
                ...
                s.stepInc = c, s.numSteps = d, m.mulAdd(e), r.value = V.ugen.lastOutputValue(e, a);
            }, m.init = function() {
                var e = m.model;
                e.level = e.unscaledValue = m.inputs.start.output[0], e.targetLevel = m.inputs.sustain.output[0], 
                m.onInputChanged();
            }, m.init(), m;
        }, V.ugenDefaults("flock.ugen.asr", {
            rate: "control",
            inputs: {
                start: 0,
                attack: .01,
        ...
        }), V.copyUGenDefinition("flock.ugen.asr", "flock.ugen.env.simpleASR"), V.ugen.envGen = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.krGen = function(e) {
                var t, n = s.model, r = s.output, a = s.inputs, o = a.gate.output[0], i = a.timeScale.output[0], u = 0;
                for (V.ugen.envGen.checkGate(s, o, i); u < e; ) t = Math.min(e - u, n.numSegmentSamps), 
                s.lineGen.gen(t, u, r, n), u += t, n.numSegmentSamps -= t, n.numSegmentSamps <= 0 && V.ugen.envGen.nextStage(s, i);
                s.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, s.arGen = function(e) {
                var t, n = s.model, r = s.output, a = s.inputs, o = a.gate.output, i = a.timeScale.output[0];
                for (t = 0; t < e; t++) V.ugen.envGen.checkGate(s, o[t], i), s.lineGen.gen(1, t, r, n), 
                n.numSegmentSamps--, n.numSegmentSamps <= 0 && V.ugen.envGen.nextStage(s, i);
                s.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, s.onInputChanged = function(e) {
                e && "envelope" !== e || (s.envelope = V.ugen.envGen.initEnvelope(s, s.inputs.envelope)), 
                e && "gate" !== e || (s.gen = s.inputs.gate.rate === V.rates.AUDIO ? s.arGen : s.krGen), 
                V.onMulAddInputChanged(s);
            }, s.onInputChanged(), s;
        }, V.ugen.envGen.initEnvelope = function(e, t) {
            var n = e.model, r = V.envelope.expand(t);
            return n.stage = 0, n.numStages = r.times.length, e.lineGen = V.line.constant, V.ugen.envGen.lineGenForStage(e.inputs.timeScale.output[0], r, n), 
            n.unscaledValue = r.levels[n.stage], r;
        }, V.ugen.envGen.checkGate = function(e, t, n) {
            var r = e.model, a = e.envelope;
            t !== r.previousGate && (0 < t && r.previousGate <= 0 ? (r.stage = 1, e.lineGen = V.ugen.envGen.lineGenForStage(n, a, r)) : t <= 0 && 0 < r.previousGate && (r.stage = r.numStages, 
            e.lineGen = V.ugen.envGen.lineGenForStage(n, a, r))), r.previousGate = t;
        }, V.ugen.envGen.nextStage = function(e, t) {
            var n = e.model, r = e.envelope;
            n.stage === r.sustainPoint ? (e.lineGen = V.line.constant, n.numSegmentSamps = 1 / 0, 
            n.destination = n.unscaledValue) : (n.stage++, e.lineGen = V.ugen.envGen.lineGenForStage(t, r, n));
        }, V.ugen.envGen.setupStage = function(e, t, n) {
        ...
        }, V.ugen.envGen.lineGenForStage = function(e, t, n) {
            var r, a, o = t.curve;
            return r = 0 === n.stage || n.stage > n.numStages ? V.line.constant : (a = o[n.stage - 1], 
            n.currentCurve = a, V.lineGenerator(a)), V.ugen.envGen.setupStage(e, t, n), r.init(n), 
            r;
        }, V.ugenDefaults("flock.ugen.envGen", {
            rate: "audio",
            inputs: {
            ...
            return l.gen = function(e) {
                ...
                l.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
            }, l.onInputChanged(), l;
        }, V.ugenDefaults("flock.ugen.phasor", {
            rate: "control",
            inputs: {
                start: 0,
                end: 1,
    ...
    !function() {
        ...
        V.ugen.lag = function(e, t, n) {
            ...
            return o.gen = function() {
                ...
                var e = o.options.recipe, t = "string" == typeof e ? V.get(e) : e;
                ...
                o.filterEngine = new r(t.sizes.b, t.sizes.a), o.model.coeffs = {
                    a: o.filterEngine.a,
                    b: o.filterEngine.b
                }, o.updateCoefficients = V.get(t, o.options.type), o.onInputChanged();
            }, o.init(), o;
        }, V.ugenDefaults("flock.ugen.filter", {
            rate: "audio",
            inputs: {
                freq: 440,
                q: 1,
        ...
        }), V.ugen.filter.biquad = function(e, t, n) {
            var c = V.ugen(e, t, n);
            return c.gen = function(e) {
                ...
                r.prevQ = s, r.prevFreq = u, r.value = r.unscaledValue = V.ugen.lastOutputValue(e, o);
            }, c.onInputChanged = function() {
                var e = c.options.type;
                c.updateCoefficients = "string" == typeof e ? V.get(e) : e;
            }, c.init = function() {
        ...
        }, V.ugenDefaults("flock.ugen.filter.biquad", {
            inputs: {
                freq: 440,
                q: 1,
                source: null
            }
        }), V.ugen.filter.biquad.types = {
            hp: {
                inputDefaults: {
                    freq: 440,
                    q: 1
        ...
        }, V.aliasUGens("flock.ugen.filter.biquad", V.ugen.filter.biquad.types), V.coefficients = {
            butterworth: {
                sizes: {
                    a: 2,
                    b: 3
                ...
                lowPass: function(e, t) {
                    var n = e.coeffs, r = 1 / Math.tan(Math.PI * t / e.sampleRate), a = r * r, o = V.ROOT2 * r, i = 1 / (1 + o + a);
                ...
                highPass: function(e, t) {
                    ...
                    r === 1 / 0 && (r = 0);
                    var a = r * r, o = V.ROOT2 * r, i = 1 / (1 + o + a);
                    n.b[0] = i, n.b[1] = -2 * i, n.b[2] = i, n.a[0] = 2 * (a - 1) * i, n.a[1] = (1 - o + a) * i;
                },
                bandPass: function(e, t, n) {
                    var r = e.coeffs, a = t / n, o = 1 / Math.tan(Math.PI * a / e.sampleRate), i = 2 * Math.cos(V.TWOPI * t / e.sampleRate), u = 1 / (1 + o);
                    r.b[0] = u, r.b[1] = 0, r.b[2] = -u, r.a[0] = -o * i * u, r.a[1] = u * (o - 1);
                },
                bandReject: function(e, t, n) {
                    var r = e.coeffs, a = t / n, o = Math.tan(Math.PI * a / e.sampleRate), i = 1 / (1 + o), u = -(2 * Math.cos(V.TWOPI * t / e.sampleRate)) * i;
            ...
            rbj: {
                ...
                lowPass: function(e, t, n) {
                    var r = e.coeffs, a = V.TWOPI * t / e.sampleRate, o = Math.cos(a), i = Math.sin(a) / (2 * n), u = 1 - o, s = 1 + i, l = u / 2 / s;
                ...
                bandPass: function(e, t, n) {
                    var r = e.coeffs, a = V.TWOPI * t / e.sampleRate, o = Math.cos(a), i = Math.sin(a) / (2 * n), u = 1 + i, s = n * i;
                    r.b[0] = s / u, r.b[1] = 0, r.b[2] = -s / u, r.a[0] = -2 * o / u, r.a[1] = (1 - i) / u;
                },
                bandReject: function(e, t, n) {
                    var r = e.coeffs, a = V.TWOPI * t / e.sampleRate, o = Math.cos(a), i = Math.sin(a) / (2 * n), u = 1 + i, s = 1 / u, l = -2 * o / u;
                    r.b[0] = s, r.b[1] = l, r.b[2] = s, r.a[0] = l, r.a[1] = (1 - i) / u;
                }
            }
        }, V.ugen.filter.moog = function(e, t, n) {
            var x = V.ugen(e, t, n);
            return x.gen = function(e) {
                var t, n, r, a, o, i, u, s = x.model, l = x.inputs, c = x.output, d = l.source.output, f = s.strides.source, p = l.resonance.output, m = s.strides.resonance, g = l.cutoff.output, h = s.strides.cutoff, v = s.f, y = s.fSq, b = s.fSqSq, k = s.oneMinusF, S = s.fb;
                ...
                s.unscaledValue = s.out4, x.mulAdd(e), s.value = V.ugen.lastOutputValue(e, c);
            }, x.onInputChanged(), x;
        }, V.ugenDefaults("flock.ugen.filter.moog", {
            rate: "audio",
            inputs: {
                cutoff: 3e3,
                resonance: 3.99,
            ...
            return l.gen = function(e) {
                ...
                r.unscaledValue = n, l.mulAdd(e), r.value = V.ugen.lastOutputValue(e, o);
            }, l.onInputChanged = function(e) {
                if (V.onMulAddInputChanged(l), !e || "maxTime" === e) {
                    var t = l.model.sampleRate * l.inputs.maxTime.output[0];
                    l.delayBuffer = new Float32Array(t);
                }
            }, l.onInputChanged(), l;
        }, V.ugenDefaults("flock.ugen.delay", {
            rate: "audio",
            inputs: {
                maxTime: 1,
                time: 1,
        ...
        }), V.ugen.delay1 = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.gen = function(e) {
                var t, n, r = s.model, a = s.inputs, o = s.output, i = a.source.output, u = r.prevVal;
                for (t = 0; t < e; t++) o[t] = n = u, u = i[t];
                r.prevVal = u, r.unscaledValue = n, s.mulAdd(e), r.value = V.ugen.lastOutputValue(e, o);
            }, s.onInputChanged = function() {
                V.onMulAddInputChanged(s);
            }, s.onInputChanged(), s;
        }, V.ugenDefaults("flock.ugen.delay1", {
            rate: "audio",
            inputs: {
                source: null
            },
        ...
        }), V.ugen.freeverb = function(e, t, n) {
            var y = V.ugen(e, t, n);
            ...
            y.gen = function(e) {
                ...
                a.unscaledValue = r, y.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
        ...
        }, V.ugenDefaults("flock.ugen.freeverb", {
            rate: "audio",
            inputs: {
                source: null,
                mix: .33,
        ...
        }), V.ugen.decay = function(e, t, n) {
            var s = V.ugen(e, t, n);
            return s.gen = function(e) {
                var t, n, r = s.model, a = s.inputs, o = s.output, i = a.source.output, u = a.time.output[0];
                if (u !== r.time && (r.time = u, r.coeff = 0 === u ? 0 : Math.exp(V.LOG001 / (u * s.model.sampleRate))), 
                0 === r.coeff) for (t = 0; t < e; t++) o[t] = n = i[t]; else for (t = 0; t < e; t++) r.lastSamp = i[t] + r.coeff * r.lastSamp, 
                o[t] = n = r.lastSamp;
                r.unscaledValue = n, s.mulAdd(e), r.value = V.ugen.lastOutputValue(e, o);
            }, s.onInputChanged(), s;
        }, V.ugenDefaults("flock.ugen.decay", {
            rate: "audio",
            inputs: {
                source: null,
                time: 1
    ...
    !function() {
        ...
        V.ugen.gate = function(e, t, n) {
            ...
            return h.gen = function(e) {
                ...
                o.lastValue = g, o.unscaledValue = a, h.mulAdd(e), o.value = V.ugen.lastOutputValue(e, u);
            }, h.onInputChanged = function() {
                h.inputs.sideChain || (h.inputs.sideChain = h.inputs.source), V.onMulAddInputChanged(h), 
                h.calculateStrides();
            }, h.onInputChanged(), h;
        }, V.ugenDefaults("flock.ugen.gate", {
            rate: "audio",
            inputs: {
                source: null,
                sideChain: null,
        ...
        }), V.ugen.timedGate = function(e, t, n) {
            var l = V.ugen(e, t, n);
            return l.gen = function(e) {
                ...
                o.unscaledValue = a, l.mulAdd(e), o.value = V.ugen.lastOutputValue(e, i);
            }, l.init = function() {
                l.onInputChanged();
            }, l.init(), l;
        }, V.ugenDefaults("flock.ugen.timedGate", {
            rate: "audio",
            inputs: {
                trigger: 0,
                duration: 1
            ...
            return d.arGen = function(e) {
                ...
                o.unscaledValue = a, d.mulAdd(e), o.value = V.ugen.lastOutputValue(e, c);
            }, d.krGen = function(e) {
                ...
                n.unscaledValue = n.holdVal, d.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, d.onInputChanged = function() {
                d.calculateStrides(), d.gen = d.inputs.trigger.rate === V.rates.AUDIO ? d.arGen : d.krGen, 
                V.onMulAddInputChanged(d);
            }, d.onInputChanged(), d;
        }, V.ugenDefaults("flock.ugen.latch", {
            rate: "audio",
            inputs: {
                source: null,
                trigger: 0,
    ...
    !function() {
        "use strict";
        V.ugen.triggerGrains = function(e, t, n) {
            var w = V.ugen(e, t, n);
            return w.gen = function(e) {
                var t, n, r, a, o, i, u, s = w.model, l = w.inputs, c = w.output, d = l.channel.output[0], f = w.buffer.data.channels[d], p = w.buffer.format.sampleRate, m = l.dur.output[0], g = l.amp.output, h = l.centerPos.output, v = l.trigger.output, y = l.speed.output, b = w.options.grainEnv, k = e - 1, S = 0, x = 0, C = 0, A = 0;
                for (t = 0; t < e; t++) {
                    if (0 < v[x] && s.prevTrigger <= 0 && s.activeGrains.length < s.maxNumGrains) {
                        for ((a = s.freeGrains.pop()).numSamps = s.sampleRate * m, a.centerIdx = a.numSamps / 2 * s.stepSize, 
                        a.envScale = w.options.grainEnv.length / a.numSamps, a.sampIdx = 0, a.amp = g[C], 
                        o = h[S] * p - a.centerIdx; o < 0; ) o += f.length;
                        a.readPos = o, a.writePos = t, a.speed = y[A], s.activeGrains.push(a);
                    }
                    s.prevTrigger = v[x], c[t] = 0, S += s.strides.centerPos, x += s.strides.trigger, 
                    C += s.strides.amp, A += s.strides.speed;
                }
                for (n = 0; n < s.activeGrains.length; ) {
                    ...
                    u = V.interpolate.linear(a.sampIdx * a.envScale, b), c[r] += i * u * a.amp, a.readPos = (a.readPos + s.stepSize * a.speed) % f.length, 
                    a.sampIdx++;
                ...
                w.onBufferInputChanged(e), w.calculateStrides(), V.onMulAddInputChanged(w);
                ...
                V.ugen.buffer(w), w.allocateGrains(), w.initBuffer(), w.onInputChanged();
            }, w.init(), w;
        }, V.ugenDefaults("flock.ugen.triggerGrains", {
            rate: "audio",
            inputs: {
                centerPos: 0,
                channel: 0,
            ...
            ugenOptions: {
                grainEnv: V.fillTable(8192, V.tableGenerators.hann),
                model: {
                    unscaledValue: 0,
                    value: 0,
                    maxNumGrains: 512,
        ...
        }), V.ugen.granulator = function(e, t, n) {
            var b = V.ugen(e, t, n);
            return b.gen = function(e) {
                ...
                t = 0; t < e; t++) {
                    ...
                    i = f[o], u = a * s.envScale, r += i * V.interpolate.linear(u, y), s.delayLineIdx[n] = ++o % s.delayLength, 
                    s.grainIdx[n] = ++a;
                    r /= g, d[t] = r;
                }
                s.unscaledValue = r, b.mulAdd(e), s.value = V.ugen.lastOutputValue(e, d);
        ...
        }, V.ugenDefaults("flock.ugen.granulator", {
            rate: "audio",
            inputs: {
                source: null,
                grainDur: .1,
            ...
            ugenOptions: {
                maxNumGrains: 512,
                maxDelayDur: 30,
                grainEnv: V.fillTable(8192, V.tableGenerators.sinWindow),
                model: {
                    unscaledValue: 0,
                    value: 0,
                    grainLength: 0,
    ...
    !function() {
        "use strict";
        V.ugen.amplitude = function(e, t, n) {
            var m = V.ugen(e, t, n);
            return m.gen = function(e) {
                ...
                for (s !== u && (a.attackTime = s, f = a.attackCoef = 0 === s ? 0 : Math.exp(V.LOG01 / (s * a.sampleRate))), 
                c !== l && (a.releaseTime = c, p = a.releaseCoef = 0 === c ? 0 : Math.exp(V.LOG01 / (c * a.sampleRate))), 
                t = 0; t < e; t++) r = (n = Math.abs(o[t])) < d ? p : f, i[t] = d = n + (d - n) * r;
                a.unscaledValue = a.prevVal = d, m.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
            }, m.onInputChanged(), m;
        }, V.ugenDefaults("flock.ugen.amplitude", {
            rate: "audio",
            inputs: {
                source: null,
                attack: .01,
    ...
    !function() {
        "use strict";
        var u = V.requireModule("webarraymath", "ArrayMath");
        V.ugen.math = function(e, t, n) {
            var i = V.ugen(e, t, n);
            return i.expandedRight = new Float32Array(i.options.audioSettings.blockSize), i.krSourceKrInputGen = function() {
                var e = i.model, t = i.activeInput, n = i.inputs[t], r = i.output, a = i.inputs.source.output[0], o = V.fillBufferWithValue(i.expandedRight, n.output[0]);
                ...
                var e = i.model, t = i.activeInput, n = i.inputs[t], r = i.output, a = i.inputs.source.output, o = V.fillBufferWithValue(i.expandedRight, n.output[0]);
                u[t](r, a, o), e.value = e.unscaledValue = r[r.length - 1];
        ...
        }, V.ugenDefaults("flock.ugen.math", {
            rate: "audio",
            inputs: {
                source: null
            }
        }), V.ugen.sum = function(e, t, n) {
            var u = V.ugen(e, t, n);
            return u.copyGen = function(e) {
                var t, n, r = u.model, a = u.output, o = u.inputs.sources.output;
                for (t = 0; t < e; t++) n = o[t], a[t] = n;
                r.unscaledValue = n, u.mulAdd(e), r.value = V.ugen.lastOutputValue(e, a);
            }, u.sumGen = function(e) {
                var t, n, r, a = u.model, o = u.inputs.sources, i = u.output;
                for (V.clearBuffer(i), n = 0; n < o.length; n++) for (r = o[n].output, t = 0; t < e; t++) i[t] += r[t];
                a.unscaledValue = V.ugen.lastOutputValue(e, i), u.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
            }, u.onInputChanged = function() {
                "number" == typeof u.inputs.sources.length ? u.gen = u.sumGen : u.gen = u.copyGen, 
                V.onMulAddInputChanged(u);
            }, u.onInputChanged(), u;
        }, V.ugenDefaults("flock.ugen.sum", {
            rate: "audio",
            inputs: {
                sources: null
            }
    ...
    !function() {
        "use strict";
        V.ugen.midiFreq = function(e, t, n) {
            var d = V.ugen(e, t, n);
            return d.gen = function(e) {
                ...
                for (n = t = 0; t < e; t++, n += a.strides.note) c[t] = r = V.midiFreq(l[n], i, u, s);
                a.unscaledValue = r, d.mulAdd(e), a.value = V.ugen.lastOutputValue(e, c);
            }, d.init = function() {
                d.model.octaveScale = 1 / d.model.notesPerOctave, d.onInputChanged();
            }, d.init(), d;
        }, V.ugenDefaults("flock.ugen.midiFreq", {
            rate: "control",
            inputs: {
                note: 69
            },
        ...
        }), V.ugen.midiAmp = function(e, t, n) {
            var u = V.ugen(e, t, n);
            return u.gen = function(e) {
                var t, n, r, a = u.model, o = u.inputs.velocity.output, i = u.output;
                for (n = t = 0; t < e; t++, n += a.strides.velocity) i[t] = r = o[n] / 127;
                a.unscaledValue = r, u.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
            }, u.init = function() {
                u.onInputChanged();
            }, u.init(), u;
        }, V.ugenDefaults("flock.ugen.midiAmp", {
            rate: "control",
            inputs: {
                velocity: 0
            },
    ...
    !function() {
        ...
        V.ugen.osc = function(e, t, n) {
            ...
            return h.gen = function(e) {
                ...
                i.phase = g, i.unscaledValue = o, h.mulAdd(e), i.value = V.ugen.lastOutputValue(e, m);
            }, h.onInputChanged = function(e) {
                if (V.ugen.osc.onInputChanged(h), !e || "table" === e) {
                    var t = h.model, n = h.inputs.table;
                    n.length < 1 && (n = h.inputs.table = V.ugen.osc.emptyTable), t.tableLen = n.length, 
                    t.tableIncHz = t.tableLen / t.sampleRate, t.tableIncRad = t.tableLen / V.TWOPI;
                }
            }, h.onInputChanged(), h;
        }, V.ugen.osc.emptyTable = new Float32Array([ 0, 0, 0 ]), V.ugen.osc.onInputChanged = function(e) {
            e.calculateStrides(), V.onMulAddInputChanged(e);
        }, V.ugenDefaults("flock.ugen.osc", {
            rate: "audio",
            inputs: {
                freq: 440,
                phase: 0,
            ...
            tableSize: 8192
        }), V.ugen.osc.define = function(e, o) {
            var t = e.lastIndexOf("."), n = e.substring(0, t), r = e.substring(t + 1);
            V.get(n)[r] = function(e, t, n) {
                var r = V.ugenDefaults("flock.ugen.osc"), a = m.merge(null, r, n).tableSize;
                return e.table = V.fillTable(a, o), V.ugen.osc(e, t, n);
            }, V.ugenDefaults(e, V.ugenDefaults("flock.ugen.osc"));
        }, V.ugen.osc.define("flock.ugen.sinOsc", V.tableGenerators.sin), V.ugen.osc.define("flock.ugen.triOsc", V.tableGenerators.tri), 
        V.ugen.osc.define("flock.ugen.sawOsc", V.tableGenerators.saw), V.ugen.osc.define("flock.ugen.squareOsc", V.tableGenerators.square), 
        V.ugen.sin = function(e, t, n) {
            var d = V.ugen(e, t, n);
            return d.gen = function(e) {
                ...
                l += i[r] / c * V.TWOPI;
                o.phase = l, o.unscaledValue = a, d.mulAdd(e), o.value = V.ugen.lastOutputValue(e, s);
            }, d.onInputChanged = function() {
                V.ugen.osc.onInputChanged(d);
            }, d.onInputChanged(), d;
        }, V.ugenDefaults("flock.ugen.sin", {
            rate: "audio",
            inputs: {
                freq: 440,
                phase: 0,
            ...
            return c.gen = function(e) {
                ...
                a.phase = l, a.unscaledValue = r, c.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
            }, c.onInputChanged = function() {
                var e = c.model;
                e.freqInc = c.inputs.freq.rate === V.rates.AUDIO ? 1 : 0, e.phase = 0, c.calculateStrides(), 
                V.onMulAddInputChanged(c);
            }, c.init = function() {
                c.model.scale = 1 / c.options.sampleRate * 2, c.onInputChanged();
            }, c.init(), c;
        }, V.ugenDefaults("flock.ugen.lfSaw", {
            rate: "audio",
            inputs: {
                freq: 440,
                phase: 0,
            ...
            return f.gen = function(e) {
                ...
                for (n = t = 0; t < e; t++, n += u) l[t] = r = 1 <= d ? (d -= 1, s < .5 ? 1 : -1) : d < s ? 1 : -1, 
                d += i[n] * c;
                o.phase = d, o.unscaledValue = r, f.mulAdd(e), o.value = V.ugen.lastOutputValue(e, l);
            }, f.onInputChanged = function() {
                f.model.freqInc = f.inputs.freq.rate === V.rates.AUDIO ? 1 : 0, V.onMulAddInputChanged(f);
            }, f.init = function() {
                f.model.scale = 1 / f.options.sampleRate, f.onInputChanged();
            }, f.init(), f;
        }, V.ugenDefaults("flock.ugen.lfPulse", {
            rate: "audio",
            inputs: {
                freq: 440,
                phase: 0,
            ...
            return f.gen = function(e) {
                ...
                c += u[n] * d;
                o.phase = c - l, o.unscaledValue = r, f.mulAdd(e), o.value = V.ugen.lastOutputValue(e, i);
            }, f.onInputChanged = function() {
                f.calculateStrides(), V.onMulAddInputChanged(f);
            }, f.init = function() {
                f.model.scale = 1 / f.model.sampleRate, f.onInputChanged();
            }, f.init(), f;
        }, V.ugenDefaults("flock.ugen.impulse", {
            rate: "audio",
            inputs: {
                freq: 440,
                phase: 0,
    ...
    !function() {
        "use strict";
        var r = V.requireModule("Random");
        V.ugen.dust = function(l, e, t) {
            var c = V.ugen(l, e, t);
            return c.gen = function(e) {
                ...
                i.unscaledValue = a, c.mulAdd(e), i.value = V.ugen.lastOutputValue(e, u);
            }, c.onInputChanged(), c;
        }, V.ugenDefaults("flock.ugen.dust", {
            rate: "audio",
            inputs: {
                density: 1,
                mul: null,
        ...
        }), V.ugen.whiteNoise = function(e, t, n) {
            var o = V.ugen(e, t, n);
            return o.gen = function(e) {
                var t, n, r = o.model, a = o.output;
                for (t = 0; t < e; t++) a[t] = n = V.randomAudioValue();
                r.unscaledValue = n, o.mulAdd(e), r.value = V.ugen.lastOutputValue(e, a);
            }, o.onInputChanged(), o;
        }, V.ugenDefaults("flock.ugen.whiteNoise", {
            rate: "audio",
            inputs: {
                mul: null,
                add: null
            }
        }), V.ugen.pinkNoise = function(e, t, n) {
            var d = V.ugen(e, t, n);
            return d.gen = function(e) {
        ...
        }, V.ugenDefaults("flock.ugen.pinkNoise", {
            rate: "audio",
            inputs: {
                mul: null,
                add: null
            ...
            return l.gen = function(e) {
                ...
                l.mulAdd(e), r.value = V.ugen.lastOutputValue(e, i);
            }, l.input = function() {
                l.model.end = Math.random(), l.onInputChanged();
            }, l.input(), l;
        }, V.ugenDefaults("flock.ugen.lfNoise", {
            rate: "audio",
            inputs: {
                freq: 440,
                mul: null,
            ...
            return i.gen = function(e) {
                ...
                "seed" === e && i.initGenerator(), V.onMulAddInputChanged(i);
        ...
        }, V.ugenDefaults("flock.ugen.random", {
            rate: "audio",
            inputs: {
                seed: null,
                mul: null,
        ...
        }), V.ugen.random.exponential = function(e, t, n) {
            var l = V.ugen.random(e, t, n);
            return l.gen = function(e) {
                ...
                a.unscaledValue = r, l.mulAdd(e), a.value = V.ugen.lastOutputValue(e, i);
            }, l;
        }, V.ugenDefaults("flock.ugen.random.exponential", {
            rate: "audio",
            inputs: {
                seed: null,
                lambda: 1,
        ...
        }), V.ugen.random.gamma = function(e, t, n) {
            var p = V.ugen.random(e, t, n);
            return p.gen = function(e) {
                ...
                o.unscaledValue = a, p.mulAdd(e), o.value = V.ugen.lastOutputValue(e, s);
            }, p;
        }, V.ugenDefaults("flock.ugen.random.gamma", {
            rate: "audio",
            inputs: {
                seed: null,
                alpha: 1,
        ...
        }), V.ugen.random.normal = function(e, t, n) {
            var p = V.ugen.random(e, t, n);
            return p.gen = function(e) {
                ...
                o.unscaledValue = a, p.mulAdd(e), o.value = V.ugen.lastOutputValue(e, i);
            }, p;
        }, V.ugenDefaults("flock.ugen.random.normal", {
            rate: "audio",
            inputs: {
                seed: null,
                mu: 0,
        ...
        }), V.ugen.random.pareto = function(e, t, n) {
            var l = V.ugen.random(e, t, n);
            return l.gen = function(e) {
        ...
        }, V.ugenDefaults("flock.ugen.random.pareto", {
            rate: "audio",
            inputs: {
                seed: null,
                alpha: 5,
        ...
        }), V.ugen.random.triangular = function(e, t, n) {
            var l = V.ugen.random(e, t, n);
            return l.gen = function(e) {
        ...
        }, V.ugenDefaults("flock.ugen.random.triangular", {
            rate: "audio",
            inputs: {
                seed: null,
                mode: .5,
        ...
        }), V.ugen.random.weibull = function(e, t, n) {
            var p = V.ugen.random(e, t, n);
            return p.gen = function(e) {
                var t, n, r, a, o = p.model, i = p.inputs, u = p.generator, s = p.output, l = o.strides.alpha, c = i.alpha.output, d = o.strides.beta, f = i.beta.output;
        ...
        }, V.ugenDefaults("flock.ugen.random.weibull", {
            rate: "audio",
            inputs: {
                seed: null,
                alpha: 1,
    ...
    !function() {
        ...
        }, V.ugenDefaults("flock.ugen.change", {
            rate: "audio",
            inputs: {
                initial: 0,
                target: 0,
        ...
        }), V.ugen.listItem = function(e, t, n) {
            var c = V.ugen(e, t, n);
            return c.gen = function(e) {
                ...
                o.unscaledValue = n, c.mulAdd(e), o.value = V.ugen.lastOutputValue(e, i);
            }, c.onInputChanged(), c;
        }, V.ugenDefaults("flock.ugen.listItem", {
            rate: "control",
            inputs: {
                index: 0,
                list: [ 0 ]
        ...
        }), V.ugen.sequence = function(e, t, n) {
            var p = V.ugen(e, t, n);
            return p.gen = function(e) {
                ...
                p.mulAdd(e), s.value = V.ugen.lastOutputValue(e, c);
            }, p.onInputChanged = function() {
                p.model.scale = p.rate !== V.rates.DEMAND ? p.model.sampleDur : 1, p.inputs.values && 0 !== p.inputs.values.length || !p.inputs.list || (V.log.warn("The 'list' input to flock.ugen.sequence is deprecated. Use 'values' instead."), 
                p.inputs.values = p.inputs.list), p.inputs.values || (p.inputs.values = []), p.calculateStrides(), 
                V.onMulAddInputChanged(p);
            }, p.init = function() {
                p.onInputChanged();
            }, p.init(), p;
        }, V.ugenDefaults("flock.ugen.sequence", {
            rate: "control",
            inputs: {
                start: 0,
                freq: 1,
        ...
        }), V.ugen.sequencer = function(e, t, n) {
            var c = V.ugen(e, t, n);
            return c.gen = function(e) {
                var t, n, r = c.model, a = c.options, o = a.resetOnNext, i = c.output, u = c.inputs.loop.output[0], s = c.inputs.durations, l = c.inputs.values;
                for (r.shouldValidateSequences && (r.shouldValidateSequences = !1, V.ugen.sequencer.validateSequences(s, l)), 
                t = 0; t < e; t++) 0 !== l.length && 0 !== s.length ? (r.samplesRemaining <= 0 ? n = r.idx < s.length - 1 ? (r.idx++, 
                V.ugen.sequencer.nextStage(s, l, o, r)) : 0 < u ? (r.idx = 0, V.ugen.sequencer.nextStage(s, l, o, r)) : a.holdLastValue ? r.unscaledValue : 0 : (n = l[r.idx], 
                r.samplesRemaining--), i[t] = n) : i[t] = n = 0;
                r.unscaledValue = n, c.mulAdd(e), r.value = V.ugen.lastOutputValue(e, i);
            }, c.onInputChanged = function(e) {
                var t = c.model, n = c.inputs;
                "durations" !== e && n.durations === t.prevDurations || (t.idx = 0, V.ugen.sequencer.calcDurationsSamps(n.durations, c.model), 
                V.ugen.sequencer.validateInput("durations", c), t.prevDurations = n.durations), 
                "values" !== e && n.values === t.prevValues || (t.idx = 0, V.ugen.sequencer.validateInput("values", c), 
                t.prevValues = n.values), c.model.shouldValidateSequences = !0, V.onMulAddInputChanged(c);
            }, c.init = function() {
                c.onInputChanged();
            }, c.init(), c;
        }, V.ugen.sequencer.validateInput = function(e, t) {
            var n = t.inputs[e];
            n && V.isIterable(n) || V.fail("No " + e + " array input was specified for flock.ugen.sequencer: " + m.prettyPrintJSON(t.options.ugenDef));
        }, V.ugen.sequencer.validateSequences = function(e, t) {
            e.length !== t.length && V.fail("Mismatched durations and values array lengths for flock.ugen.sequencer. Durations: " + m.prettyPrintJSON(e) + ", values: " + m.prettyPrintJSON(t));
        }, V.ugen.sequencer.calcDurationsSamps = function(e, t) {
            t.samplesRemaining = Math.floor(e[t.idx] * t.sampleRate);
        }, V.ugen.sequencer.nextStage = function(e, t, n, r) {
            return V.ugen.sequencer.calcDurationsSamps(e, r), r.samplesRemaining--, n ? 0 : t[r.idx];
        }, V.ugenDefaults("flock.ugen.sequencer", {
            rate: "audio",
            inputs: {
                durations: [],
                values: [],
    ...
    !function() {
        "use strict";
        V.ugen.valueChangeTrigger = function(e, t, n) {
            var u = V.ugen(e, t, n);
            return u.gen = function(e) {
        ...
        }, V.ugenDefaults("flock.ugen.valueChangeTrigger", {
            rate: "control",
            inputs: {
                source: 0
            },
        ...
        }), V.ugen.inputChangeTrigger = function(e, t, n) {
            var p = V.ugen(e, t, n);
            return p.gen = function(e) {
                ...
                i.value = i.unscaledValue = V.ugen.lastOutputValue(e, f);
            }, p.onInputChanged = function(e) {
                p.calculateStrides(), "source" === e && (p.model.prevDur = null);
            }, p.calculateStrides(), p;
        }, V.ugenDefaults("flock.ugen.inputChangeTrigger", {
            rate: "control",
            inputs: {
                source: 0,
                duration: 0
        ...
        }), V.ugen.triggerCallback = function(e, t, n) {
            var k = V.ugen(e, t, n);
        ...
        }, V.ugenDefaults("flock.ugen.triggerCallback", {
            rate: "audio",
            inputs: {
                source: 0,
                trigger: 0
    ...
    !function() {
        ...
        m.registerNamespace("flock.view"), V.view.scope = function(e, t) {
            var c = {
                model: t || {
                    values: []
                },
            ...
            return c.init(), c;
        }, V.view.drawBuffer = function(e, t) {
            (t = t || {}).height = t.height || 200, t.width = t.width || 1e3;
            var n = m.stringTemplate(V.view.drawBuffer.markupTemplate, t), r = a(n);
            return V.view.scope(r[0], {
                values: e
            }), r;
        }, V.view.drawBuffer.markupTemplate = "<canvas height='%height' width='%width'></canvas>";
    }();
    V = (m = m || require("infusion")).registerNamespace("flock");
    return function() {
        "use strict";
        var o = m.registerNamespace("jQuery");
        m.registerNamespace("flock.ugen"), V.ugen.scope = function(e, t, n) {
            var u = V.ugen(e, t, n);
            return u.gen = function(e) {
                ...
                n.bufIdx = o, n.value = n.unscaledValue = V.ugen.lastOutputValue(e, r);
            }, u.onInputChanged = function() {
                ...
                u.scopeView = V.view.scope(u.options.canvas, u.model.scope), u.onInputChanged(), 
                u.scopeView.refreshView();
            }, u.init(), u;
        }, V.ugenDefaults("flock.ugen.scope", {
            rate: "audio",
            inputs: {
                source: null
            },
        ...
        }), V.ugen.mouse = {}, V.ugen.mouse.cursor = function(e, t, n) {
            var d = V.ugen(e, t, n);
            return d.exponentialGen = function(e) {
                var t, n, r = d.model, a = V.ugen.mouse.cursor.normalize(d.target, r), o = r.movingAvg, i = d.inputs.lag.output[0], u = d.inputs.add.output[0], s = d.inputs.mul.output[0], l = r.lagCoef, c = d.output;
                for (i !== l && (l = 0 === i ? 0 : Math.exp(V.LOG001 / (i * r.sampleRate)), r.lagCoef = l), 
                t = 0; t < e; t++) n = s + u, o = (a = Math.pow(n / u, a) * u) + l * (o - a), c[t] = o;
                r.movingAvg = o, r.value = r.unscaledValue = o;
            }, d.linearGen = function(e) {
                var t, n = d.model, r = V.ugen.mouse.cursor.normalize(d.target, n), a = n.movingAvg, o = d.inputs.lag.output[0], i = d.inputs.add.output[0], u = d.inputs.mul.output[0], s = n.lagCoef, l = d.output;
                for (o !== s && (s = 0 === o ? 0 : Math.exp(V.LOG001 / (o * n.sampleRate)), n.lagCoef = s), 
                t = 0; t < e; t++) a = r + s * (a - r), l[t] = a * u + i;
                n.movingAvg = n.unscaledValue = a, n.value = V.ugen.lastOutputValue(e, l);
            }, d.noInterpolationGen = function(e) {
                var t, n = d.model, r = d.output, a = V.ugen.mouse.cursor.normalize(d.target, n);
                for (t = 0; t < e; t++) r[t] = a * d.inputs.mul.output[0] + d.inputs.add.output[0];
                n.value = n.unscaledValue = V.ugen.lastOutputValue(e, r);
                ...
                e.dimension = "x" === n || "width" === n || "horizontal" === n ? (e.eventProp = "clientX", 
                e.offsetProp = "left", "width") : (e.eventProp = "clientY", e.offsetProp = "top", 
                "height"), d.target = r, e.mousePosition = 0, e.movingAvg = 0, d.bindEvents(), d.onInputChanged();
            }, d.init(), d;
        }, V.ugen.mouse.cursor.normalize = function(e, t) {
        ...
        }, V.ugenDefaults("flock.ugen.mouse.cursor", {
            rate: "control",
            inputs: {
                lag: .5,
                add: 0,
            ...
            return a.gen = function(e) {
                ...
                V.onMulAddInputChanged(a);
            }, a.init(), a;
        }, V.ugenDefaults("flock.ugen.mouse.click", {
            rate: "control"
        }), V.ugen.mediaIn = function(e, t, n) {
            var i = V.ugen(e, t, n);
            return i.gen = function(e) {
                for (var t, n = i.model, r = i.output, a = i.bus, o = 0; o < e; o++) r[o] = t = a[o];
                n.unscaledValue = t, i.mulAdd(e), n.value = V.ugen.lastOutputValue(e, r);
            }, i.onInputChanged = function() {
                V.onMulAddInputChanged(i);
            }, i.init = function() {
                var e = i.enviro.audioSystem.nativeNodeManager, t = o(i.options.element), n = e.createMediaElementInput(t[0]);
                i.bus = i.options.buses[n], i.onInputChanged(), V.platform.browser.safari && V.platform.browser.majorVersionNumber < 601 ? V.log.warn("MediaElementSourceNode only works on Safari 9 or higher. For more information, see https://bugs.webkit.org/show_bug.cgi?id=84743 and https://bugs.webkit.org/show_bug.cgi?id=125031") : V.platform.isAndroid && V.log.warn("MediaElementSourceNode does not work on Android. For more information, see https://code.google.com/p/chromium/issues/detail?id=419446");
            }, i.init(), i;
        }, V.ugenDefaults("flock.ugen.mediaIn", {
            rate: "audio",
            inputs: {
                mul: null,
                add: null
