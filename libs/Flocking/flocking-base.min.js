...
!function() {
    ...
    if (!e.Filter) {
        ...
        t.prototype.filter = function(e, t) {
            ...
            for (n = 0; (c || d) && n < s; ++n) {
                ...
                m = i - c, c && c--;
                var h = a[0] * t[n];
                for (I = 1; I < m; ++I) h += a[I] * t[n - I];
                for (;I < i; ++I) h += a[I] * u[I - m];
                for (m = r - d, d && d--, I = 0; I < m; ++I) h -= o[I] * e[n - 1 - I];
                for (;I < r; ++I) h -= o[I] * l[I - m];
                e[n] = h;
            }
            if (3 == i && 2 == r) for (var p, k, g = a[0], v = a[1], b = a[2], y = o[0], w = o[1], A = t[n - 1], N = t[n - 2], M = e[n - 1], S = e[n - 2]; n < s; ++n) p = N, 
            N = A, k = S, M = g * (A = t[n]) + v * N + b * p - y * (S = M) - w * k, e[n] = M; else for (;n < s; ++n) {
                var I;
                h = a[0] * t[n];
                for (I = 1; I < i; ++I) h += a[I] * t[n - I];
                for (I = 0; I < r; ++I) h -= o[I] * e[n - 1 - I];
                e[n] = h;
            }
            var C = Math.min(i - 1, s);
            for (n = i - 2; C <= n; --n) u[n] = u[n - C];
            for (n = 0; n < C; ++n) u[n] = t[s - 1 - n];
            for (C = Math.min(r, f), n = r - 1; C <= n; --n) l[n] = l[n - C];
    ...
    var e = "undefined" != typeof window ? window : "undefined" != typeof self ? self : "undefined" != typeof module && module.exports ? module.exports : global;
    if (!e.FFT) {
        var b = function(e, t, n, o, r, a, i, l, u, s, f, c, d, m) {
            var h = u[s++], p = u[s++], k = n, g = n + h * p, v = i * l;
            if (1 == p) for (;e[n] = o[a], t[n] = r[a], a += v, ++n != g; ) ; else for (;b(e, t, n, o, r, a, i * h, l, u, s, f, c, d, m), 
            a += v, (n += p) != g; ) ;
            switch (n = k, h) {
              case 2:
              ...
              case 4:
                !function(e, t, n, o, r, a, i, l) {
                    ...
                    t[T] = w + p, t[V] = l ? (e[B] = v - g, t[B] = b + k, e[V] = v + g, b - k) : (e[B] = v + g, 
                    t[B] = b - k, e[V] = v - g, b + k), D += o, F += O, P += R, ++T, ++B, ++E, ++V;
                }(e, t, n, i, f, c, p, m);
                break;
                ...
                !function(e, t, n, o, r, a, i, l, u) {
                    ...
                    for (s = 0; s < i; ++s) {
                        ...
                        for (f = 0; f < l; ++f) {
                            m = b[0], h = y[0];
                            var N = 0;
                            for (c = 1; c < l; ++c) u <= (N += A) && (N -= u), p = b[c], k = y[c], m += p * (g = r[N]) - k * (v = a[N]), 
                            h += p * v + k * g;
                            e[d] = m, t[d] = h, d += i, A += o;
                        }
                    }
        ...
        t.prototype.forwardCplx = function(e, t, n, o) {
            ...
            b(e, t, 0, n, o, 0, 1, 1, this._factors, 0, r, a, this.size, !1);
            ...
            b(e, t, 0, n, o, 0, 1, 1, this._factors, 0, r, a, this.size, !0);
...
!function() {
    ...
    flock.ugenDefaults = function(e, t) {
        ...
        t.mulAdd = n || o ? (e = n ? o ? n.rate !== flock.rates.AUDIO ? o.rate !== flock.rates.AUDIO ? flock.krMulKrAdd : flock.krMulAdd : o.rate !== flock.rates.AUDIO ? flock.mulKrAdd : flock.mulAdd : n.rate !== flock.rates.AUDIO ? flock.krMul : flock.mul : o.rate !== flock.rates.AUDIO ? flock.krAdd : flock.add, 
